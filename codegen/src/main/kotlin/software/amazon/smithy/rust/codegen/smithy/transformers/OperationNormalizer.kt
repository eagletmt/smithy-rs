...
class OperationNormalizer(private val model: Model) {
    ...
    private fun syntheticOutputShapes(
        ...
        val outputShape = outputShapeBuilder.addTrait(SyntheticOutputTrait(operation.id, outputBodyShape?.id, operation.output.orNull())).build()
    ...
    private fun syntheticInputShapes(
        ...
        val inputShape = inputShapeBuilder.addTrait(SyntheticInputTrait(operation.id, inputBodyShape?.id, operation.input.orNull())).build()
