...
pub mod create_api_key_input {
    ...
    impl Builder {
        ...
        pub fn stage_keys(mut self, inp: std::vec::Vec<crate::model::StageKey>) -> Self {
...
pub mod get_deployment_input {
    ...
    impl Builder {
        ...
        pub fn embed(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.embed = Some(inp);
            self
        }
        pub fn set_embed(
...
pub mod test_invoke_authorizer_input {
    ...
    impl Builder {
        ...
        pub fn additional_context(
            ...
            self.additional_context = Some(inp);
            self
        }
...
pub mod update_account_input {
    ...
    impl Builder {
        ...
        pub fn patch_operations(
            mut self,
            inp: std::vec::Vec<crate::model::PatchOperation>,
        ) -> Self {
            self.patch_operations = Some(inp);
            self
        }
