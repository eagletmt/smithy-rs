...
pub mod update_vpc_link_output {
    ...
    impl Builder {
        ...
        /// <p>The ARN of the network load balancer of the VPC targeted by the VPC link. The network load balancer must be owned by the same AWS account of the API owner.</p>
        pub fn target_arns(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.target_arns = Some(inp);
            self
        }
...
pub mod update_usage_plan_output {
    ...
    impl Builder {
        ...
        /// <p>The associated API stages of a usage plan.</p>
        pub fn api_stages(mut self, inp: std::vec::Vec<crate::model::ApiStage>) -> Self {
            self.api_stages = Some(inp);
            self
        }
...
pub mod update_usage_output {
    ...
    impl Builder {
        ...
        pub fn items(
            mut self,
            inp: std::collections::HashMap<std::string::String, std::vec::Vec<std::vec::Vec<i64>>>,
        ) -> Self {
            self.items = Some(inp);
            self
        }
...
pub mod update_stage_output {
    ...
    impl Builder {
        ...
        pub fn method_settings(
            mut self,
            inp: std::collections::HashMap<std::string::String, crate::model::MethodSetting>,
        ) -> Self {
            self.method_settings = Some(inp);
            self
        }
...
pub mod update_rest_api_output {
    ...
    impl Builder {
        ...
        /// <p>The warning messages reported when <code>failonwarnings</code> is turned on during API import.</p>
        pub fn warnings(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.warnings = Some(inp);
            self
        }
        pub fn set_warnings(
            mut self,
        ...
        /// <p>The list of binary media types supported by the <a>RestApi</a>. By default, the <a>RestApi</a> supports only UTF-8-encoded text payloads.</p>
        pub fn binary_media_types(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.binary_media_types = Some(inp);
            self
        }
...
pub mod update_resource_output {
    ...
    impl Builder {
        ...
        pub fn resource_methods(
            mut self,
            inp: std::collections::HashMap<std::string::String, crate::model::Method>,
        ) -> Self {
            self.resource_methods = Some(inp);
            self
        }
...
pub mod update_method_response_output {
    ...
    impl Builder {
        ...
        pub fn response_parameters(
            ...
            self.response_parameters = Some(inp);
            self
        }
...
pub mod update_method_output {
    ...
    impl Builder {
        ...
        pub fn request_parameters(
            ...
            self.request_parameters = Some(inp);
            self
        }
        ...
        pub fn method_responses(
            mut self,
            inp: std::collections::HashMap<std::string::String, crate::model::MethodResponse>,
        ) -> Self {
            self.method_responses = Some(inp);
            self
        }
        ...
        /// <p>A list of authorization scopes configured on the method. The scopes are used with a <code>COGNITO_USER_POOLS</code> authorizer to authorize the method invocation. The authorization works by matching the method scopes against the scopes parsed from the access token in the incoming request. The method invocation is authorized if any method scopes matches a claimed scope in the access token. Otherwise, the invocation is not authorized. When the method scope is configured, the client must provide an access token instead of an identity token for authorization purposes.</p>
        pub fn authorization_scopes(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.authorization_scopes = Some(inp);
            self
        }
...
pub mod update_integration_response_output {
    ...
    impl Builder {
        ...
        pub fn response_templates(
            ...
            self.response_templates = Some(inp);
            self
        }
...
pub mod update_integration_output {
    ...
    impl Builder {
        ...
        pub fn request_templates(
            ...
            self.request_templates = Some(inp);
            self
        }
        ...
        /// <p>A list of request parameters whose values API Gateway caches. To be valid values for <code>cacheKeyParameters</code>, these parameters must also be specified for <a>Method</a> <code>requestParameters</code>.</p>
        pub fn cache_key_parameters(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.cache_key_parameters = Some(inp);
            self
        }
        ...
        pub fn integration_responses(
            mut self,
            inp: std::collections::HashMap<std::string::String, crate::model::IntegrationResponse>,
        ) -> Self {
            self.integration_responses = Some(inp);
            self
        }
...
pub mod update_authorizer_output {
    ...
    impl Builder {
        ...
        /// <p>A list of the Amazon Cognito user pool ARNs for the <code>COGNITO_USER_POOLS</code> authorizer. Each element is of this format: <code>arn:aws:cognito-idp:{region}:{account_id}:userpool/{user_pool_id}</code>. For a <code>TOKEN</code> or <code>REQUEST</code> authorizer, this is not defined.</p>
        pub fn provider_ar_ns(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.provider_ar_ns = Some(inp);
            self
        }
...
pub mod update_api_key_output {
    ...
    impl Builder {
        ...
        /// <p>A list of <a>Stage</a> resources that are associated with the <a>ApiKey</a> resource.</p>
        pub fn stage_keys(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.stage_keys = Some(inp);
            self
        }
...
pub mod update_account_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        cloudwatch_role_arn: std::option::Option<std::string::String>,
        throttle_settings: std::option::Option<crate::model::ThrottleSettings>,
        features: std::option::Option<std::vec::Vec<std::string::String>>,
        api_key_version: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The ARN of an Amazon CloudWatch role for the current <a>Account</a>. </p>
        ...
        /// <p>A list of features supported for the account. When usage plans are enabled, the features list will include an entry of <code>"UsagePlans"</code>.</p>
        pub fn features(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.features = Some(inp);
            self
        }
        pub fn set_features(
            mut self,
...
pub mod test_invoke_method_output {
    ...
    pub struct Builder {
        ...
        multi_value_headers: std::option::Option<
            std::collections::HashMap<std::string::String, std::vec::Vec<std::string::String>>,
        >,
        log: std::option::Option<std::string::String>,
        latency: std::option::Option<i64>,
    }
    impl Builder {
        /// <p>The HTTP status code.</p>
        ...
        pub fn multi_value_headers(
            ...
            self.multi_value_headers = Some(inp);
            self
        }
...
pub mod test_invoke_authorizer_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        client_status: std::option::Option<i32>,
        log: std::option::Option<std::string::String>,
        latency: std::option::Option<i64>,
        principal_id: std::option::Option<std::string::String>,
        policy: std::option::Option<std::string::String>,
        authorization: std::option::Option<
            std::collections::HashMap<std::string::String, std::vec::Vec<std::string::String>>,
        >,
        claims: std::option::Option<
            std::collections::HashMap<std::string::String, std::string::String>,
        >,
    }
    impl Builder {
...
pub mod import_documentation_parts_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        ids: std::option::Option<std::vec::Vec<std::string::String>>,
        warnings: std::option::Option<std::vec::Vec<std::string::String>>,
    }
    impl Builder {
        /// <p>A list of the returned documentation part identifiers.</p>
        pub fn ids(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.ids = Some(inp);
            self
        }
        pub fn set_ids(
...
pub mod get_vpc_links_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::VpcLink>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::VpcLink>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_usage_plans_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::UsagePlan>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::UsagePlan>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_usage_plan_keys_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::UsagePlanKey>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::UsagePlanKey>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_stages_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        item: std::option::Option<std::vec::Vec<crate::model::Stage>>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn item(mut self, inp: std::vec::Vec<crate::model::Stage>) -> Self {
            self.item = Some(inp);
            self
        }
        pub fn set_item(
...
pub mod get_sdk_types_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::SdkType>>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::SdkType>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_sdk_type_output {
    ...
    impl Builder {
        ...
        pub fn configuration_properties(
            mut self,
            inp: std::vec::Vec<crate::model::SdkConfigurationProperty>,
        ) -> Self {
            self.configuration_properties = Some(inp);
            self
        }
...
pub mod get_sdk_output {
    ...
    pub struct Builder {
        content_type: std::option::Option<std::string::String>,
        content_disposition: std::option::Option<std::string::String>,
...
pub mod get_rest_apis_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::RestApi>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::RestApi>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_resources_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::Resource>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::Resource>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_request_validators_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::RequestValidator>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::RequestValidator>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_models_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::Model>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::Model>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_gateway_responses_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::GatewayResponse>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>Returns the entire collection, because of no pagination support.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::GatewayResponse>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_domain_names_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::DomainName>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::DomainName>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_documentation_versions_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::DocumentationVersion>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::DocumentationVersion>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_documentation_parts_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::DocumentationPart>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::DocumentationPart>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_deployments_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::Deployment>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::Deployment>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_client_certificates_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::ClientCertificate>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::ClientCertificate>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_base_path_mappings_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::BasePathMapping>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::BasePathMapping>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_authorizers_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        items: std::option::Option<std::vec::Vec<crate::model::Authorizer>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::Authorizer>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
...
pub mod get_api_keys_output {
    ...
    pub struct Builder {
        warnings: std::option::Option<std::vec::Vec<std::string::String>>,
        items: std::option::Option<std::vec::Vec<crate::model::ApiKey>>,
        position: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>A list of warning messages logged during the import of API keys when the <code>failOnWarnings</code> option is set to true.</p>
        ...
        /// <p>The current page of elements from this collection.</p>
        pub fn items(mut self, inp: std::vec::Vec<crate::model::ApiKey>) -> Self {
            self.items = Some(inp);
            self
        }
        pub fn set_items(
