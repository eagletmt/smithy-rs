...
pub mod update_key_description_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> UpdateKeyDescriptionOutput {
...
pub mod update_alias_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> UpdateAliasOutput {
            UpdateAliasOutput {}
        }
    }
}
...
pub mod revoke_grant_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> RevokeGrantOutput {
            RevokeGrantOutput {}
        }
    }
}
...
pub mod retire_grant_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> RetireGrantOutput {
            RetireGrantOutput {}
        }
    }
}
...
pub mod put_key_policy_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> PutKeyPolicyOutput {
            PutKeyPolicyOutput {}
        }
    }
}
...
pub mod list_retirable_grants_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        grants: ::std::option::Option<::std::vec::Vec<GrantListEntry>>,
        next_marker: ::std::option::Option<::std::string::String>,
        truncated: ::std::option::Option<bool>,
    }
    impl Builder {
        /// <p>A list of grants.</p>
        pub fn grants(mut self, inp: ::std::vec::Vec<GrantListEntry>) -> Self {
            self.grants = Some(inp);
            self
        }
        /// <p>When <code>Truncated</code> is true, this element is present and contains the
        /// value to use for the <code>Marker</code> parameter in a subsequent request.</p>
...
pub mod list_resource_tags_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ListResourceTagsOutput {
...
pub mod list_keys_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        keys: ::std::option::Option<::std::vec::Vec<KeyListEntry>>,
        next_marker: ::std::option::Option<::std::string::String>,
        truncated: ::std::option::Option<bool>,
    }
    impl Builder {
        /// <p>A list of customer master keys (CMKs).</p>
        pub fn keys(mut self, inp: ::std::vec::Vec<KeyListEntry>) -> Self {
            self.keys = Some(inp);
            self
        }
        /// <p>When <code>Truncated</code> is true, this element is present and contains the
...
pub mod list_key_policies_output {
    ...
    impl Builder {
        /// <p>A list of key policy names. The only valid value is <code>default</code>.</p>
        pub fn policy_names(mut self, inp: ::std::vec::Vec<::std::string::String>) -> Self {
            self.policy_names = Some(inp);
            self
        }
        /// <p>When <code>Truncated</code> is true, this element is present and contains the
        /// value to use for the <code>Marker</code> parameter in a subsequent request.</p>
...
pub mod list_grants_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ListGrantsOutput {
            ListGrantsOutput {
                grants: self.grants,
                next_marker: self.next_marker,
                truncated: self.truncated.unwrap_or_default(),
...
pub mod list_aliases_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        aliases: ::std::option::Option<::std::vec::Vec<AliasListEntry>>,
        next_marker: ::std::option::Option<::std::string::String>,
        truncated: ::std::option::Option<bool>,
    }
    impl Builder {
        /// <p>A list of aliases.</p>
        pub fn aliases(mut self, inp: ::std::vec::Vec<AliasListEntry>) -> Self {
            self.aliases = Some(inp);
            self
        }
        /// <p>When <code>Truncated</code> is true, this element is present and contains the
        /// value to use for the <code>Marker</code> parameter in a subsequent request.</p>
...
pub struct GetPublicKeyOutput {
    ...
    /// <p></p>
    pub public_key: ::std::option::Option<Blob>,
...
pub mod get_public_key_output {
    ...
    pub struct Builder {
        key_id: ::std::option::Option<::std::string::String>,
        public_key: ::std::option::Option<Blob>,
    ...
    impl Builder {
        ...
        /// <code>SubjectPublicKeyInfo</code> (SPKI), as defined in <a href="https://tools.ietf.org/html/rfc5280">RFC 5280</a>. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.</p>
        /// <p></p>
        pub fn public_key(mut self, inp: Blob) -> Self {
...
pub mod get_parameters_for_import_output {
    ...
    pub struct Builder {
        ...
        public_key: ::std::option::Option<Blob>,
        parameters_valid_to: ::std::option::Option<Instant>,
    }
    impl Builder {
        /// <p>The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN</a>) of the CMK to use in a subsequent <a>ImportKeyMaterial</a>
        /// request. This is the same CMK specified in the <code>GetParametersForImport</code>
        ...
        /// you cannot use them to make an <a>ImportKeyMaterial</a> request and you must send
        /// another <code>GetParametersForImport</code> request to get new ones.</p>
        pub fn parameters_valid_to(mut self, inp: Instant) -> Self {
        ...
        pub fn build(self) -> GetParametersForImportOutput {
...
pub mod get_key_policy_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> GetKeyPolicyOutput {
            GetKeyPolicyOutput {
                policy: self.policy,
            }
        }
...
pub mod generate_data_key_pair_without_plaintext_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        private_key_ciphertext_blob: ::std::option::Option<Blob>,
        public_key: ::std::option::Option<Blob>,
        key_id: ::std::option::Option<::std::string::String>,
    ...
    impl Builder {
        /// <p>The encrypted copy of the private key. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.</p>
        pub fn private_key_ciphertext_blob(mut self, inp: Blob) -> Self {
...
pub struct GenerateDataKeyPairOutput {
    ...
    pub private_key_plaintext: ::std::option::Option<Blob>,
    /// <p>The public key (in plaintext).</p>
    pub public_key: ::std::option::Option<Blob>,
    /// <p>The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN</a>) of the CMK that encrypted the private key.</p>
    pub key_id: ::std::option::Option<::std::string::String>,
...
pub mod generate_data_key_pair_output {
    ...
    pub struct Builder {
        private_key_ciphertext_blob: ::std::option::Option<Blob>,
        private_key_plaintext: ::std::option::Option<Blob>,
        public_key: ::std::option::Option<Blob>,
        key_id: ::std::option::Option<::std::string::String>,
        key_pair_spec: ::std::option::Option<DataKeyPairSpec>,
    }
    impl Builder {
        ...
        /// <p>The plaintext copy of the private key. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.</p>
        pub fn private_key_plaintext(mut self, inp: Blob) -> Self {
...
pub mod enable_key_rotation_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> EnableKeyRotationOutput {
...
pub mod enable_key_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> EnableKeyOutput {
            EnableKeyOutput {}
        }
    }
}
...
pub mod disconnect_custom_key_store_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DisconnectCustomKeyStoreOutput {
...
pub mod disable_key_rotation_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DisableKeyRotationOutput {
...
pub mod disable_key_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DisableKeyOutput {
            DisableKeyOutput {}
        }
    }
}
...
pub mod describe_key_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        key_metadata: ::std::option::Option<KeyMetadata>,
    }
    impl Builder {
        /// <p>Metadata associated with the key.</p>
        pub fn key_metadata(mut self, inp: KeyMetadata) -> Self {
...
pub mod describe_custom_key_stores_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        custom_key_stores: ::std::option::Option<::std::vec::Vec<CustomKeyStoresListEntry>>,
        next_marker: ::std::option::Option<::std::string::String>,
        truncated: ::std::option::Option<bool>,
    }
    impl Builder {
        /// <p>Contains metadata about each custom key store.</p>
        pub fn custom_key_stores(mut self, inp: ::std::vec::Vec<CustomKeyStoresListEntry>) -> Self {
            self.custom_key_stores = Some(inp);
            self
        }
        /// <p>When <code>Truncated</code> is true, this element is present and contains the
        /// value to use for the <code>Marker</code> parameter in a subsequent request.</p>
...
pub mod delete_imported_key_material_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DeleteImportedKeyMaterialOutput {
...
pub mod delete_alias_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DeleteAliasOutput {
            DeleteAliasOutput {}
        }
    }
}
...
pub mod create_key_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> CreateKeyOutput {
            CreateKeyOutput {
                key_metadata: self.key_metadata,
            }
        }
...
pub mod connect_custom_key_store_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ConnectCustomKeyStoreOutput {
...
pub mod cancel_key_deletion_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> CancelKeyDeletionOutput {
