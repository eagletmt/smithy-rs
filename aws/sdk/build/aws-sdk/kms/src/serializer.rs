...
pub struct CreateGrantInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub operations: &'a ::std::option::Option<::std::vec::Vec<GrantOperation>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub constraints: &'a ::std::option::Option<GrantConstraints>,
...
pub struct CreateKeyInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub key_usage: &'a ::std::option::Option<KeyUsageType>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub customer_master_key_spec: &'a ::std::option::Option<CustomerMasterKeySpec>,
    ...
    #[serde(rename = "Origin")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub origin: &'a ::std::option::Option<OriginType>,
...
pub struct DecryptInputBody<'a> {
    ...
    pub ciphertext_blob: &'a ::std::option::Option<Blob>,
...
pub struct EncryptInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(serialize_with = "crate::serde_util::stdoptionoptionblob_ser")]
    pub plaintext: &'a ::std::option::Option<Blob>,
...
pub struct GenerateDataKeyInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub key_spec: &'a ::std::option::Option<DataKeySpec>,
    /// <p>A list of grant tokens.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token">Grant Tokens</a> in the
    /// <i>AWS Key Management Service Developer Guide</i>.</p>
    #[serde(rename = "GrantTokens")]
...
pub struct GenerateDataKeyPairInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub key_pair_spec: &'a ::std::option::Option<DataKeyPairSpec>,
    /// <p>A list of grant tokens.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token">Grant Tokens</a> in the
    /// <i>AWS Key Management Service Developer Guide</i>.</p>
    #[serde(rename = "GrantTokens")]
...
pub struct GetParametersForImportInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub wrapping_algorithm: &'a ::std::option::Option<AlgorithmSpec>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub wrapping_key_spec: &'a ::std::option::Option<WrappingKeySpec>,
}
...
pub struct ImportKeyMaterialInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(serialize_with = "crate::serde_util::stdoptionoptionblob_ser")]
    pub import_token: &'a ::std::option::Option<Blob>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(serialize_with = "crate::serde_util::stdoptionoptionblob_ser")]
    pub encrypted_key_material: &'a ::std::option::Option<Blob>,
    ...
    pub valid_to: &'a ::std::option::Option<Instant>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub expiration_model: &'a ::std::option::Option<ExpirationModelType>,
}
...
pub struct ReEncryptInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source_encryption_algorithm: &'a ::std::option::Option<EncryptionAlgorithmSpec>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub destination_encryption_algorithm: &'a ::std::option::Option<EncryptionAlgorithmSpec>,
    /// <p>A list of grant tokens.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token">Grant Tokens</a> in the
    /// <i>AWS Key Management Service Developer Guide</i>.</p>
    #[serde(rename = "GrantTokens")]
...
pub struct SignInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(serialize_with = "crate::serde_util::stdoptionoptionblob_ser")]
    pub message: &'a ::std::option::Option<Blob>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub message_type: &'a ::std::option::Option<MessageType>,
    /// <p>A list of grant tokens.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token">Grant Tokens</a> in the
    /// <i>AWS Key Management Service Developer Guide</i>.</p>
    #[serde(rename = "GrantTokens")]
...
pub struct VerifyInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(serialize_with = "crate::serde_util::stdoptionoptionblob_ser")]
    pub signature: &'a ::std::option::Option<Blob>,
