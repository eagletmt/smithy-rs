...
pub mod synthesis_task {
    ...
    impl Builder {
        ...
        /// synthesis. Lexicons are applied only if the language of the lexicon is the same as the
        /// language of the voice. </p>
        pub fn lexicon_names(mut self, inp: std::vec::Vec<std::string::String>) -> Self {
            self.lexicon_names = Some(inp);
            self
        }
        ...
        /// <p>The type of speech marks returned for the input text.</p>
        pub fn speech_mark_types(
            mut self,
            inp: std::vec::Vec<crate::model::SpeechMarkType>,
        ) -> Self {
            self.speech_mark_types = Some(inp);
            self
        }
...
pub mod voice {
    ...
    impl Builder {
        ...
        pub fn additional_language_codes(
            mut self,
            inp: std::vec::Vec<crate::model::LanguageCode>,
        ) -> Self {
            self.additional_language_codes = Some(inp);
            self
        }
        ...
        /// <p>Specifies which engines (<code>standard</code> or <code>neural</code>) that are supported
        /// by a given voice.</p>
        pub fn supported_engines(mut self, inp: std::vec::Vec<crate::model::Engine>) -> Self {
            self.supported_engines = Some(inp);
            self
        }
