...
pub struct SynthesizeSpeechOutput {
    ...
    pub audio_stream: std::option::Option<smithy_types::Blob>,
...
pub mod synthesize_speech_output {
    ...
    pub struct Builder {
        audio_stream: std::option::Option<smithy_types::Blob>,
        content_type: std::option::Option<std::string::String>,
        request_characters: std::option::Option<i32>,
    }
    impl Builder {
        /// <p> Stream containing the synthesized speech. </p>
        pub fn audio_stream(mut self, inp: smithy_types::Blob) -> Self {
            self.audio_stream = Some(inp);
            self
        }
        pub fn set_audio_stream(mut self, inp: std::option::Option<smithy_types::Blob>) -> Self {
            self.audio_stream = inp;
            self
        }
        /// <p> Specifies the type audio stream. This should reflect the <code>OutputFormat</code>
        /// parameter in your request. </p>
...
pub mod list_speech_synthesis_tasks_output {
    ...
    impl Builder {
        ...
        /// <p>List of SynthesisTask objects that provides information from the specified task in the
        /// list request, including output format, creation time, task status, and so on.</p>
        pub fn synthesis_tasks(mut self, inp: std::vec::Vec<crate::model::SynthesisTask>) -> Self {
            self.synthesis_tasks = Some(inp);
            self
        }
...
pub mod list_lexicons_output {
    ...
    impl Builder {
        /// <p>A list of lexicon names and attributes.</p>
        pub fn lexicons(mut self, inp: std::vec::Vec<crate::model::LexiconDescription>) -> Self {
            self.lexicons = Some(inp);
            self
        }
        pub fn set_lexicons(
            mut self,
...
pub mod describe_voices_output {
    ...
    impl Builder {
        /// <p>A list of voices with their properties.</p>
        pub fn voices(mut self, inp: std::vec::Vec<crate::model::Voice>) -> Self {
            self.voices = Some(inp);
            self
        }
        pub fn set_voices(
            mut self,
