...
use crate::model::RotationRulesType;
use crate::model::SortOrderType;
use crate::model::Tag;
use crate::serializer::CancelRotateSecretInputBody;
use crate::serializer::CreateSecretInputBody;
use crate::serializer::DeleteResourcePolicyInputBody;
use crate::serializer::DeleteSecretInputBody;
use crate::serializer::DescribeSecretInputBody;
use crate::serializer::GetRandomPasswordInputBody;
use crate::serializer::GetResourcePolicyInputBody;
use crate::serializer::GetSecretValueInputBody;
use crate::serializer::ListSecretVersionIdsInputBody;
use crate::serializer::ListSecretsInputBody;
use crate::serializer::PutResourcePolicyInputBody;
use crate::serializer::PutSecretValueInputBody;
use crate::serializer::RestoreSecretInputBody;
use crate::serializer::RotateSecretInputBody;
use crate::serializer::TagResourceInputBody;
use crate::serializer::UntagResourceInputBody;
use crate::serializer::UpdateSecretInputBody;
use crate::serializer::UpdateSecretVersionStageInputBody;
use crate::serializer::ValidateResourcePolicyInputBody;
...
pub mod cancel_rotate_secret_input {
    ...
    use crate::operation::CancelRotateSecret;
    ...
    impl Builder {
        ...
        ) -> ::smithy_http::operation::Operation<CancelRotateSecret, ()> {
            let op = CancelRotateSecret::new(CancelRotateSecretInput {
...
impl CancelRotateSecretInput {
    ...
    fn body(&self) -> CancelRotateSecretInputBody {
        CancelRotateSecretInputBody {
            secret_id: &self.secret_id,
        }
    }
...
pub mod create_secret_input {
    ...
    use crate::model::Tag;
    use crate::operation::CreateSecret;
    use smithy_types::Blob;
    ...
    pub struct Builder {
        ...
        secret_binary: ::std::option::Option<Blob>,
    ...
    impl Builder {
        ...
        pub fn secret_binary(mut self, inp: Blob) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<CreateSecret, ()> {
            let op = CreateSecret::new(CreateSecretInput {
                name: self.name,
                tags: self.tags,
...
impl CreateSecretInput {
    ...
    fn body(&self) -> CreateSecretInputBody {
...
pub mod delete_resource_policy_input {
    ...
    use crate::operation::DeleteResourcePolicy;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DeleteResourcePolicy, ()> {
            let op = DeleteResourcePolicy::new(DeleteResourcePolicyInput {
                secret_id: self.secret_id,
            });
...
impl DeleteResourcePolicyInput {
    ...
    fn body(&self) -> DeleteResourcePolicyInputBody {
        DeleteResourcePolicyInputBody {
            secret_id: &self.secret_id,
        }
    }
    pub fn build_body(&self) -> ::std::vec::Vec<u8> {
...
pub mod delete_secret_input {
    ...
    use crate::operation::DeleteSecret;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DeleteSecret, ()> {
            let op = DeleteSecret::new(DeleteSecretInput {
...
impl DeleteSecretInput {
    ...
    fn body(&self) -> DeleteSecretInputBody {
        DeleteSecretInputBody {
            force_delete_without_recovery: &self.force_delete_without_recovery,
            recovery_window_in_days: &self.recovery_window_in_days,
            secret_id: &self.secret_id,
        }
...
pub mod describe_secret_input {
    ...
    use crate::operation::DescribeSecret;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DescribeSecret, ()> {
            let op = DescribeSecret::new(DescribeSecretInput {
                secret_id: self.secret_id,
            });
...
impl DescribeSecretInput {
    ...
    fn body(&self) -> DescribeSecretInputBody {
        DescribeSecretInputBody {
            secret_id: &self.secret_id,
        }
    }
    pub fn build_body(&self) -> ::std::vec::Vec<u8> {
...
pub mod get_random_password_input {
    ...
    use crate::operation::GetRandomPassword;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<GetRandomPassword, ()> {
            let op = GetRandomPassword::new(GetRandomPasswordInput {
...
impl GetRandomPasswordInput {
    ...
    fn body(&self) -> GetRandomPasswordInputBody {
        GetRandomPasswordInputBody {
            exclude_numbers: &self.exclude_numbers,
            exclude_characters: &self.exclude_characters,
            password_length: &self.password_length,
            require_each_included_type: &self.require_each_included_type,
...
pub mod get_resource_policy_input {
    ...
    use crate::operation::GetResourcePolicy;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<GetResourcePolicy, ()> {
            let op = GetResourcePolicy::new(GetResourcePolicyInput {
                secret_id: self.secret_id,
            });
...
impl GetResourcePolicyInput {
    ...
    fn body(&self) -> GetResourcePolicyInputBody {
        GetResourcePolicyInputBody {
            secret_id: &self.secret_id,
        }
    }
    pub fn build_body(&self) -> ::std::vec::Vec<u8> {
...
pub mod get_secret_value_input {
    ...
    use crate::operation::GetSecretValue;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<GetSecretValue, ()> {
            let op = GetSecretValue::new(GetSecretValueInput {
                secret_id: self.secret_id,
...
impl GetSecretValueInput {
    ...
    fn body(&self) -> GetSecretValueInputBody {
        GetSecretValueInputBody {
            secret_id: &self.secret_id,
            version_stage: &self.version_stage,
            version_id: &self.version_id,
        }
...
pub mod list_secrets_input {
    ...
    impl Builder {
        ...
        pub fn sort_order(mut self, inp: SortOrderType) -> Self {
        ...
        pub fn filters(mut self, inp: ::std::vec::Vec<Filter>) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ListSecrets, ()> {
            let op = ListSecrets::new(ListSecretsInput {
...
impl ListSecretsInput {
    ...
    fn body(&self) -> ListSecretsInputBody {
        ListSecretsInputBody {
            max_results: &self.max_results,
            sort_order: &self.sort_order,
            next_token: &self.next_token,
            filters: &self.filters,
...
pub mod list_secret_version_ids_input {
    ...
    use crate::operation::ListSecretVersionIds;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ListSecretVersionIds, ()> {
            let op = ListSecretVersionIds::new(ListSecretVersionIdsInput {
                max_results: self.max_results,
                secret_id: self.secret_id,
                next_token: self.next_token,
...
impl ListSecretVersionIdsInput {
    ...
    fn body(&self) -> ListSecretVersionIdsInputBody {
        ListSecretVersionIdsInputBody {
            max_results: &self.max_results,
            secret_id: &self.secret_id,
            next_token: &self.next_token,
            include_deprecated: &self.include_deprecated,
...
pub mod put_resource_policy_input {
    ...
    use crate::operation::PutResourcePolicy;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<PutResourcePolicy, ()> {
            let op = PutResourcePolicy::new(PutResourcePolicyInput {
...
impl PutResourcePolicyInput {
    ...
    fn body(&self) -> PutResourcePolicyInputBody {
        PutResourcePolicyInputBody {
            resource_policy: &self.resource_policy,
            block_public_policy: &self.block_public_policy,
            secret_id: &self.secret_id,
        }
...
pub mod put_secret_value_input {
    ...
    use crate::operation::PutSecretValue;
    use smithy_types::Blob;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<PutSecretValue, ()> {
...
impl PutSecretValueInput {
    ...
    fn body(&self) -> PutSecretValueInputBody {
        PutSecretValueInputBody {
            client_request_token: &self.client_request_token,
            secret_id: &self.secret_id,
            secret_string: &self.secret_string,
            secret_binary: &self.secret_binary,
...
pub mod restore_secret_input {
    ...
    use crate::operation::RestoreSecret;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<RestoreSecret, ()> {
            let op = RestoreSecret::new(RestoreSecretInput {
                secret_id: self.secret_id,
            });
...
impl RestoreSecretInput {
    ...
    fn body(&self) -> RestoreSecretInputBody {
        RestoreSecretInputBody {
            secret_id: &self.secret_id,
        }
    }
    pub fn build_body(&self) -> ::std::vec::Vec<u8> {
...
pub mod rotate_secret_input {
    ...
    use crate::model::RotationRulesType;
    use crate::operation::RotateSecret;
    ...
    pub struct Builder {
        secret_id: ::std::option::Option<::std::string::String>,
        client_request_token: ::std::option::Option<::std::string::String>,
        rotation_rules: ::std::option::Option<RotationRulesType>,
    ...
    impl Builder {
        ...
        pub fn rotation_rules(mut self, inp: RotationRulesType) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<RotateSecret, ()> {
            let op = RotateSecret::new(RotateSecretInput {
                secret_id: self.secret_id,
                client_request_token: self
                    .client_request_token
                    .or_else(|| Some(_config.token_provider.token())),
...
impl RotateSecretInput {
    ...
    fn body(&self) -> RotateSecretInputBody {
...
pub mod update_secret_input {
    ...
    use crate::operation::UpdateSecret;
    use smithy_types::Blob;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<UpdateSecret, ()> {
            let op = UpdateSecret::new(UpdateSecretInput {
                secret_string: self.secret_string,
                kms_key_id: self.kms_key_id,
                secret_id: self.secret_id,
                description: self.description,
...
impl UpdateSecretInput {
    ...
    fn body(&self) -> UpdateSecretInputBody {
...
pub mod update_secret_version_stage_input {
    ...
    use crate::operation::UpdateSecretVersionStage;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<UpdateSecretVersionStage, ()> {
            let op = UpdateSecretVersionStage::new(UpdateSecretVersionStageInput {
...
impl UpdateSecretVersionStageInput {
    ...
    fn body(&self) -> UpdateSecretVersionStageInputBody {
        UpdateSecretVersionStageInputBody {
            move_to_version_id: &self.move_to_version_id,
            secret_id: &self.secret_id,
            remove_from_version_id: &self.remove_from_version_id,
            version_stage: &self.version_stage,
...
pub mod validate_resource_policy_input {
    ...
    use crate::operation::ValidateResourcePolicy;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ValidateResourcePolicy, ()> {
            let op = ValidateResourcePolicy::new(ValidateResourcePolicyInput {
                resource_policy: self.resource_policy,
                secret_id: self.secret_id,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("ValidateResourcePolicy", "secretsmanager"),
            )
        }
    }
}
impl ValidateResourcePolicyInput {
    ...
    fn body(&self) -> ValidateResourcePolicyInputBody {
        ValidateResourcePolicyInputBody {
            resource_policy: &self.resource_policy,
            secret_id: &self.secret_id,
        }
    }
...
pub struct RotateSecretInput {
    ...
    pub client_request_token: ::std::option::Option<::std::string::String>,
    /// <p>A structure that defines the rotation configuration for this secret.</p>
    pub rotation_rules: ::std::option::Option<RotationRulesType>,
    /// <p>(Optional) Specifies the ARN of the Lambda function that can rotate the secret.</p>
...
pub struct ListSecretsInput {
    ...
    pub max_results: ::std::option::Option<i32>,
    /// <p>Lists secrets in the requested order. </p>
    pub sort_order: ::std::option::Option<SortOrderType>,
    /// <p>(Optional) Use this parameter in a request if you receive a
    /// <code>NextToken</code> response in a previous request indicating there's more
    /// output available. In a subsequent call, set it to the value of the previous call
    /// <code>NextToken</code> response to indicate where the output should continue from.</p>
    pub next_token: ::std::option::Option<::std::string::String>,
    /// <p>Lists the secret request filters.</p>
    pub filters: ::std::option::Option<::std::vec::Vec<Filter>>,
}
