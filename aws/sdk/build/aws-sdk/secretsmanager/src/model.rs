...
pub struct Filter {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub key: ::std::option::Option<FilterNameStringType>,
...
pub mod filter {
    ...
    use crate::model::FilterNameStringType;
    /// A builder for [`Filter`](crate::model::Filter)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        key: ::std::option::Option<FilterNameStringType>,
        values: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    }
    impl Builder {
        /// <p>Filters your list of secrets by a specific key.</p>
        pub fn key(mut self, inp: FilterNameStringType) -> Self {
            self.key = Some(inp);
            self
        }
        /// <p>Filters your list of secrets by a specific value.</p>
