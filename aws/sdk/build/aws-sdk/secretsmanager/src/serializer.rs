...
pub struct ListSecretsInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: &'a ::std::option::Option<SortOrderType>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub filters: &'a ::std::option::Option<::std::vec::Vec<Filter>>,
}
...
pub struct RotateSecretInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rotation_rules: &'a ::std::option::Option<RotationRulesType>,
