...
use crate::model::SecretListEntry;
use crate::model::SecretVersionsListEntry;
use crate::model::Tag;
use crate::model::ValidationErrorsEntry;
...
pub mod validate_resource_policy_output {
    ...
    pub struct Builder {
        validation_errors: ::std::option::Option<::std::vec::Vec<ValidationErrorsEntry>>,
        policy_validation_passed: ::std::option::Option<bool>,
    }
    impl Builder {
        /// <p>Returns an error message if your policy doesn't pass validatation.</p>
        pub fn validation_errors(mut self, inp: ::std::vec::Vec<ValidationErrorsEntry>) -> Self {
...
pub mod update_secret_version_stage_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> UpdateSecretVersionStageOutput {
...
pub struct ListSecretVersionIdsOutput {
    ...
    pub versions: ::std::option::Option<::std::vec::Vec<SecretVersionsListEntry>>,
...
pub mod list_secret_version_ids_output {
    ...
    pub struct Builder {
        ...
        versions: ::std::option::Option<::std::vec::Vec<SecretVersionsListEntry>>,
        arn: ::std::option::Option<::std::string::String>,
        name: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        ...
        /// <p>The list of the currently available versions of the specified secret.</p>
        pub fn versions(mut self, inp: ::std::vec::Vec<SecretVersionsListEntry>) -> Self {
...
pub mod list_secrets_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        secret_list: ::std::option::Option<::std::vec::Vec<SecretListEntry>>,
        next_token: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        /// <p>A list of the secrets in the account.</p>
        pub fn secret_list(mut self, inp: ::std::vec::Vec<SecretListEntry>) -> Self {
...
pub struct GetSecretValueOutput {
    ...
    pub created_date: ::std::option::Option<Instant>,
...
pub mod get_secret_value_output {
    ...
    pub struct Builder {
        version_id: ::std::option::Option<::std::string::String>,
        created_date: ::std::option::Option<Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date and time that this version of the secret was created.</p>
        pub fn created_date(mut self, inp: Instant) -> Self {
        ...
        pub fn build(self) -> GetSecretValueOutput {
...
pub struct DescribeSecretOutput {
    ...
    pub last_rotated_date: ::std::option::Option<Instant>,
    ...
    pub last_changed_date: ::std::option::Option<Instant>,
    ...
    pub last_accessed_date: ::std::option::Option<Instant>,
    ...
    pub deleted_date: ::std::option::Option<Instant>,
    /// <p>The ARN of the secret.</p>
    pub arn: ::std::option::Option<::std::string::String>,
...
pub mod describe_secret_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        last_rotated_date: ::std::option::Option<Instant>,
        ...
        version_ids_to_stages: ::std::option::Option<
            ...
            >,
        >,
        last_changed_date: ::std::option::Option<Instant>,
        rotation_rules: ::std::option::Option<RotationRulesType>,
        name: ::std::option::Option<::std::string::String>,
        rotation_enabled: ::std::option::Option<bool>,
        last_accessed_date: ::std::option::Option<Instant>,
        created_date: ::std::option::Option<Instant>,
        deleted_date: ::std::option::Option<Instant>,
        arn: ::std::option::Option<::std::string::String>,
    ...
    impl Builder {
        /// <p>The most recent date and time that the Secrets Manager rotation process was successfully
        /// completed. This value is null if the secret has never rotated.</p>
        pub fn last_rotated_date(mut self, inp: Instant) -> Self {
        ...
        /// <p>The last date and time that this secret was modified in any way.</p>
        pub fn last_changed_date(mut self, inp: Instant) -> Self {
        ...
        /// <p>The last date that this secret was accessed. This value is truncated to midnight of the
        /// date and therefore shows only the date, not the time.</p>
        pub fn last_accessed_date(mut self, inp: Instant) -> Self {
        ...
        /// <p>If a secret is scheduled for deletion, then its details, including the encrypted secret
        /// information, is not accessible. To cancel a scheduled deletion and restore access, use <a>RestoreSecret</a>.</p>
        pub fn deleted_date(mut self, inp: Instant) -> Self {
