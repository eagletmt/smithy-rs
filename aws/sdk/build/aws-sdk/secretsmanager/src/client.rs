...
{
    pub fn cancel_rotate_secret(&self) -> fluent_builders::CancelRotateSecret<C> {
        fluent_builders::CancelRotateSecret::new(self.handle.clone())
    }
    pub fn create_secret(&self) -> fluent_builders::CreateSecret<C> {
    ...
    pub fn delete_secret(&self) -> fluent_builders::DeleteSecret<C> {
        fluent_builders::DeleteSecret::new(self.handle.clone())
    }
    pub fn describe_secret(&self) -> fluent_builders::DescribeSecret<C> {
        fluent_builders::DescribeSecret::new(self.handle.clone())
    }
    pub fn get_random_password(&self) -> fluent_builders::GetRandomPassword<C> {
    ...
    pub fn get_secret_value(&self) -> fluent_builders::GetSecretValue<C> {
        fluent_builders::GetSecretValue::new(self.handle.clone())
    }
    pub fn list_secrets(&self) -> fluent_builders::ListSecrets<C> {
        fluent_builders::ListSecrets::new(self.handle.clone())
    }
    pub fn list_secret_version_ids(&self) -> fluent_builders::ListSecretVersionIds<C> {
    ...
    pub fn put_secret_value(&self) -> fluent_builders::PutSecretValue<C> {
        fluent_builders::PutSecretValue::new(self.handle.clone())
    }
    pub fn restore_secret(&self) -> fluent_builders::RestoreSecret<C> {
        fluent_builders::RestoreSecret::new(self.handle.clone())
    }
    pub fn rotate_secret(&self) -> fluent_builders::RotateSecret<C> {
    ...
    pub fn update_secret(&self) -> fluent_builders::UpdateSecret<C> {
        fluent_builders::UpdateSecret::new(self.handle.clone())
    }
    pub fn update_secret_version_stage(&self) -> fluent_builders::UpdateSecretVersionStage<C> {
        fluent_builders::UpdateSecretVersionStage::new(self.handle.clone())
    }
    pub fn validate_resource_policy(&self) -> fluent_builders::ValidateResourcePolicy<C> {
        fluent_builders::ValidateResourcePolicy::new(self.handle.clone())
    }
}
pub mod fluent_builders {
    #[derive(std::fmt::Debug)]
    pub struct CancelRotateSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::cancel_rotate_secret_input::Builder,
    }
    impl<C> CancelRotateSecret<C> {
    ...
    #[derive(std::fmt::Debug)]
    pub struct CreateSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::create_secret_input::Builder,
    }
    impl<C> CreateSecret<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DeleteSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::delete_secret_input::Builder,
    }
    impl<C> DeleteSecret<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_secret_input::Builder,
    }
    impl<C> DescribeSecret<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetRandomPassword<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_random_password_input::Builder,
    }
    impl<C> GetRandomPassword<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetSecretValue<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_secret_value_input::Builder,
    }
    impl<C> GetSecretValue<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListSecrets<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_secrets_input::Builder,
    }
    impl<C> ListSecrets<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListSecretVersionIds<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_secret_version_ids_input::Builder,
    }
    impl<C> ListSecretVersionIds<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutSecretValue<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_secret_value_input::Builder,
    }
    impl<C> PutSecretValue<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct RestoreSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::restore_secret_input::Builder,
    }
    impl<C> RestoreSecret<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct RotateSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::rotate_secret_input::Builder,
    }
    impl<C> RotateSecret<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct UpdateSecret<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::update_secret_input::Builder,
    }
    impl<C> UpdateSecret<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct UpdateSecretVersionStage<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::update_secret_version_stage_input::Builder,
    }
    impl<C> UpdateSecretVersionStage<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ValidateResourcePolicy<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::validate_resource_policy_input::Builder,
    }
    impl<C> ValidateResourcePolicy<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
