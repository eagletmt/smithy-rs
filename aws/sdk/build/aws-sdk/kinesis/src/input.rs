...
use crate::model::MetricsName;
use crate::model::PutRecordsRequestEntry;
use crate::model::ScalingType;
use crate::model::ShardFilter;
use crate::model::ShardIteratorType;
use crate::model::StartingPosition;
use crate::serializer::AddTagsToStreamInputBody;
use crate::serializer::CreateStreamInputBody;
use crate::serializer::DecreaseStreamRetentionPeriodInputBody;
use crate::serializer::DeleteStreamInputBody;
use crate::serializer::DeregisterStreamConsumerInputBody;
use crate::serializer::DescribeStreamConsumerInputBody;
use crate::serializer::DescribeStreamInputBody;
use crate::serializer::DescribeStreamSummaryInputBody;
use crate::serializer::DisableEnhancedMonitoringInputBody;
use crate::serializer::EnableEnhancedMonitoringInputBody;
use crate::serializer::GetRecordsInputBody;
use crate::serializer::GetShardIteratorInputBody;
use crate::serializer::IncreaseStreamRetentionPeriodInputBody;
use crate::serializer::ListShardsInputBody;
use crate::serializer::ListStreamConsumersInputBody;
use crate::serializer::ListStreamsInputBody;
use crate::serializer::ListTagsForStreamInputBody;
use crate::serializer::MergeShardsInputBody;
use crate::serializer::PutRecordInputBody;
use crate::serializer::PutRecordsInputBody;
use crate::serializer::RegisterStreamConsumerInputBody;
use crate::serializer::RemoveTagsFromStreamInputBody;
use crate::serializer::SplitShardInputBody;
use crate::serializer::StartStreamEncryptionInputBody;
use crate::serializer::StopStreamEncryptionInputBody;
use crate::serializer::SubscribeToShardInputBody;
use crate::serializer::UpdateShardCountInputBody;
...
pub mod add_tags_to_stream_input {
    ...
    use crate::operation::AddTagsToStream;
    ...
    impl Builder {
        ...
        pub fn build(
        ...
        ) -> ::smithy_http::operation::Operation<AddTagsToStream, ()> {
            let op = AddTagsToStream::new(AddTagsToStreamInput {
                tags: self.tags,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("AddTagsToStream", "kinesis"),
            )
        }
    }
}
impl AddTagsToStreamInput {
    ...
    fn body(&self) -> AddTagsToStreamInputBody {
        AddTagsToStreamInputBody {
            tags: &self.tags,
            stream_name: &self.stream_name,
        }
    }
...
pub mod create_stream_input {
    ...
    use crate::operation::CreateStream;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<CreateStream, ()> {
            let op = CreateStream::new(CreateStreamInput {
                stream_name: self.stream_name,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("CreateStream", "kinesis"),
            )
        }
    }
}
impl CreateStreamInput {
    ...
    fn body(&self) -> CreateStreamInputBody {
...
pub mod decrease_stream_retention_period_input {
    ...
    use crate::operation::DecreaseStreamRetentionPeriod;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DecreaseStreamRetentionPeriod, ()> {
            let op = DecreaseStreamRetentionPeriod::new(DecreaseStreamRetentionPeriodInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DecreaseStreamRetentionPeriod", "kinesis"),
            )
        }
    }
}
impl DecreaseStreamRetentionPeriodInput {
    ...
    fn body(&self) -> DecreaseStreamRetentionPeriodInputBody {
        DecreaseStreamRetentionPeriodInputBody {
            retention_period_hours: &self.retention_period_hours,
            stream_name: &self.stream_name,
        }
    }
...
pub mod delete_stream_input {
    ...
    use crate::operation::DeleteStream;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DeleteStream, ()> {
            let op = DeleteStream::new(DeleteStreamInput {
                stream_name: self.stream_name,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DeleteStream", "kinesis"),
            )
        }
    }
}
impl DeleteStreamInput {
    ...
    fn body(&self) -> DeleteStreamInputBody {
        DeleteStreamInputBody {
            stream_name: &self.stream_name,
            enforce_consumer_deletion: &self.enforce_consumer_deletion,
        }
    }
...
pub mod deregister_stream_consumer_input {
    ...
    use crate::operation::DeregisterStreamConsumer;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DeregisterStreamConsumer, ()> {
            let op = DeregisterStreamConsumer::new(DeregisterStreamConsumerInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DeregisterStreamConsumer", "kinesis"),
            )
        }
    }
}
impl DeregisterStreamConsumerInput {
    ...
    fn body(&self) -> DeregisterStreamConsumerInputBody {
        DeregisterStreamConsumerInputBody {
            stream_arn: &self.stream_arn,
            consumer_name: &self.consumer_name,
            consumer_arn: &self.consumer_arn,
        }
...
pub mod describe_limits_input {
    ...
    impl Builder {
        ...
        pub fn build(
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DescribeLimits", "kinesis"),
            )
        }
    }
}
...
pub mod describe_stream_input {
    ...
    use crate::operation::DescribeStream;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DescribeStream, ()> {
            let op = DescribeStream::new(DescribeStreamInput {
                stream_name: self.stream_name,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DescribeStream", "kinesis"),
            )
        }
    }
}
impl DescribeStreamInput {
    ...
    fn body(&self) -> DescribeStreamInputBody {
        DescribeStreamInputBody {
            stream_name: &self.stream_name,
            exclusive_start_shard_id: &self.exclusive_start_shard_id,
            limit: &self.limit,
        }
...
pub mod describe_stream_consumer_input {
    ...
    use crate::operation::DescribeStreamConsumer;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DescribeStreamConsumer, ()> {
            let op = DescribeStreamConsumer::new(DescribeStreamConsumerInput {
                stream_arn: self.stream_arn,
                consumer_name: self.consumer_name,
                consumer_arn: self.consumer_arn,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DescribeStreamConsumer", "kinesis"),
            )
        }
    }
}
impl DescribeStreamConsumerInput {
    ...
    fn body(&self) -> DescribeStreamConsumerInputBody {
        DescribeStreamConsumerInputBody {
            stream_arn: &self.stream_arn,
            consumer_name: &self.consumer_name,
            consumer_arn: &self.consumer_arn,
        }
...
pub mod describe_stream_summary_input {
    ...
    use crate::operation::DescribeStreamSummary;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DescribeStreamSummary, ()> {
            let op = DescribeStreamSummary::new(DescribeStreamSummaryInput {
                stream_name: self.stream_name,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DescribeStreamSummary", "kinesis"),
            )
        }
    }
}
impl DescribeStreamSummaryInput {
    ...
    fn body(&self) -> DescribeStreamSummaryInputBody {
        DescribeStreamSummaryInputBody {
            stream_name: &self.stream_name,
        }
    }
    pub fn build_body(&self) -> ::std::vec::Vec<u8> {
...
pub mod disable_enhanced_monitoring_input {
    ...
    use crate::model::MetricsName;
    use crate::operation::DisableEnhancedMonitoring;
    /// A builder for [`DisableEnhancedMonitoringInput`](crate::input::DisableEnhancedMonitoringInput)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        shard_level_metrics: ::std::option::Option<::std::vec::Vec<MetricsName>>,
        stream_name: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        ...
        pub fn shard_level_metrics(mut self, inp: ::std::vec::Vec<MetricsName>) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<DisableEnhancedMonitoring, ()> {
            let op = DisableEnhancedMonitoring::new(DisableEnhancedMonitoringInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("DisableEnhancedMonitoring", "kinesis"),
            )
        }
    }
}
impl DisableEnhancedMonitoringInput {
    ...
    fn body(&self) -> DisableEnhancedMonitoringInputBody {
        DisableEnhancedMonitoringInputBody {
            shard_level_metrics: &self.shard_level_metrics,
            stream_name: &self.stream_name,
        }
    }
...
pub mod enable_enhanced_monitoring_input {
    ...
    use crate::model::MetricsName;
    use crate::operation::EnableEnhancedMonitoring;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<EnableEnhancedMonitoring, ()> {
            let op = EnableEnhancedMonitoring::new(EnableEnhancedMonitoringInput {
                stream_name: self.stream_name,
                shard_level_metrics: self.shard_level_metrics,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("EnableEnhancedMonitoring", "kinesis"),
            )
        }
    }
}
impl EnableEnhancedMonitoringInput {
    ...
    fn body(&self) -> EnableEnhancedMonitoringInputBody {
        EnableEnhancedMonitoringInputBody {
            stream_name: &self.stream_name,
            shard_level_metrics: &self.shard_level_metrics,
        }
    }
...
pub mod get_records_input {
    ...
    use crate::operation::GetRecords;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<GetRecords, ()> {
            let op = GetRecords::new(GetRecordsInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("GetRecords", "kinesis"),
            )
        }
    }
}
impl GetRecordsInput {
    ...
    fn body(&self) -> GetRecordsInputBody {
        GetRecordsInputBody {
            shard_iterator: &self.shard_iterator,
            limit: &self.limit,
        }
...
pub mod get_shard_iterator_input {
    ...
    use crate::model::ShardIteratorType;
    use crate::operation::GetShardIterator;
    use smithy_types::Instant;
    /// A builder for [`GetShardIteratorInput`](crate::input::GetShardIteratorInput)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        shard_iterator_type: ::std::option::Option<ShardIteratorType>,
    ...
    impl Builder {
        ...
        /// </li>
        /// </ul>
        pub fn shard_iterator_type(mut self, inp: ShardIteratorType) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<GetShardIterator, ()> {
            let op = GetShardIterator::new(GetShardIteratorInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("GetShardIterator", "kinesis"),
            )
        }
    }
}
impl GetShardIteratorInput {
    ...
    fn body(&self) -> GetShardIteratorInputBody {
        GetShardIteratorInputBody {
            shard_iterator_type: &self.shard_iterator_type,
            shard_id: &self.shard_id,
            starting_sequence_number: &self.starting_sequence_number,
            timestamp: &self.timestamp,
...
pub mod increase_stream_retention_period_input {
    ...
    use crate::operation::IncreaseStreamRetentionPeriod;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<IncreaseStreamRetentionPeriod, ()> {
            let op = IncreaseStreamRetentionPeriod::new(IncreaseStreamRetentionPeriodInput {
                retention_period_hours: self.retention_period_hours,
                stream_name: self.stream_name,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("IncreaseStreamRetentionPeriod", "kinesis"),
            )
        }
    }
}
impl IncreaseStreamRetentionPeriodInput {
    ...
    fn body(&self) -> IncreaseStreamRetentionPeriodInputBody {
        IncreaseStreamRetentionPeriodInputBody {
            retention_period_hours: &self.retention_period_hours,
            stream_name: &self.stream_name,
        }
    }
...
pub mod list_shards_input {
    ...
    use crate::model::ShardFilter;
    use crate::operation::ListShards;
    use smithy_types::Instant;
    ...
    pub struct Builder {
        ...
        stream_creation_timestamp: ::std::option::Option<Instant>,
        next_token: ::std::option::Option<::std::string::String>,
        exclusive_start_shard_id: ::std::option::Option<::std::string::String>,
        shard_filter: ::std::option::Option<ShardFilter>,
        stream_name: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        ...
        /// parameter.</p>
        pub fn stream_creation_timestamp(mut self, inp: Instant) -> Self {
        ...
        pub fn shard_filter(mut self, inp: ShardFilter) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ListShards, ()> {
            let op = ListShards::new(ListShardsInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("ListShards", "kinesis"),
            )
        }
    }
}
impl ListShardsInput {
    ...
    fn body(&self) -> ListShardsInputBody {
        ListShardsInputBody {
            max_results: &self.max_results,
            stream_creation_timestamp: &self.stream_creation_timestamp,
            next_token: &self.next_token,
...
pub mod list_stream_consumers_input {
    ...
    use crate::operation::ListStreamConsumers;
    use smithy_types::Instant;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ListStreamConsumers, ()> {
            let op = ListStreamConsumers::new(ListStreamConsumersInput {
                next_token: self.next_token,
                stream_creation_timestamp: self.stream_creation_timestamp,
                stream_arn: self.stream_arn,
                max_results: self.max_results,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("ListStreamConsumers", "kinesis"),
            )
        }
    }
}
impl ListStreamConsumersInput {
    ...
    fn body(&self) -> ListStreamConsumersInputBody {
        ListStreamConsumersInputBody {
            next_token: &self.next_token,
            stream_creation_timestamp: &self.stream_creation_timestamp,
            stream_arn: &self.stream_arn,
            max_results: &self.max_results,
...
pub mod list_streams_input {
    ...
    use crate::operation::ListStreams;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ListStreams, ()> {
            let op = ListStreams::new(ListStreamsInput {
                limit: self.limit,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("ListStreams", "kinesis"),
            )
        }
    }
}
impl ListStreamsInput {
    ...
    fn body(&self) -> ListStreamsInputBody {
        ListStreamsInputBody {
            limit: &self.limit,
            exclusive_start_stream_name: &self.exclusive_start_stream_name,
        }
    }
...
pub mod list_tags_for_stream_input {
    ...
    use crate::operation::ListTagsForStream;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<ListTagsForStream, ()> {
            let op = ListTagsForStream::new(ListTagsForStreamInput {
                limit: self.limit,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("ListTagsForStream", "kinesis"),
            )
        }
    }
}
impl ListTagsForStreamInput {
    ...
    fn body(&self) -> ListTagsForStreamInputBody {
        ListTagsForStreamInputBody {
            limit: &self.limit,
            exclusive_start_tag_key: &self.exclusive_start_tag_key,
            stream_name: &self.stream_name,
        }
...
pub mod merge_shards_input {
    ...
    use crate::operation::MergeShards;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<MergeShards, ()> {
            let op = MergeShards::new(MergeShardsInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("MergeShards", "kinesis"),
            )
        }
    }
}
impl MergeShardsInput {
    ...
    fn body(&self) -> MergeShardsInputBody {
        MergeShardsInputBody {
            adjacent_shard_to_merge: &self.adjacent_shard_to_merge,
            stream_name: &self.stream_name,
            shard_to_merge: &self.shard_to_merge,
        }
...
pub mod put_record_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<PutRecord, ()> {
            let op = PutRecord::new(PutRecordInput {
                stream_name: self.stream_name,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("PutRecord", "kinesis"),
            )
        }
    }
}
impl PutRecordInput {
    ...
    fn body(&self) -> PutRecordInputBody {
        PutRecordInputBody {
            stream_name: &self.stream_name,
            explicit_hash_key: &self.explicit_hash_key,
            sequence_number_for_ordering: &self.sequence_number_for_ordering,
...
pub mod put_records_input {
    ...
    use crate::model::PutRecordsRequestEntry;
    use crate::operation::PutRecords;
    /// A builder for [`PutRecordsInput`](crate::input::PutRecordsInput)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        records: ::std::option::Option<::std::vec::Vec<PutRecordsRequestEntry>>,
        stream_name: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        /// <p>The records associated with the request.</p>
        pub fn records(mut self, inp: ::std::vec::Vec<PutRecordsRequestEntry>) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<PutRecords, ()> {
            let op = PutRecords::new(PutRecordsInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("PutRecords", "kinesis"),
            )
        }
    }
}
impl PutRecordsInput {
    ...
    fn body(&self) -> PutRecordsInputBody {
        PutRecordsInputBody {
            records: &self.records,
            stream_name: &self.stream_name,
        }
...
pub mod register_stream_consumer_input {
    ...
    use crate::operation::RegisterStreamConsumer;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<RegisterStreamConsumer, ()> {
            let op = RegisterStreamConsumer::new(RegisterStreamConsumerInput {
                consumer_name: self.consumer_name,
                stream_arn: self.stream_arn,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("RegisterStreamConsumer", "kinesis"),
            )
        }
    }
}
impl RegisterStreamConsumerInput {
    ...
    fn body(&self) -> RegisterStreamConsumerInputBody {
        RegisterStreamConsumerInputBody {
            consumer_name: &self.consumer_name,
            stream_arn: &self.stream_arn,
        }
    }
...
pub mod remove_tags_from_stream_input {
    ...
    use crate::operation::RemoveTagsFromStream;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<RemoveTagsFromStream, ()> {
            let op = RemoveTagsFromStream::new(RemoveTagsFromStreamInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("RemoveTagsFromStream", "kinesis"),
            )
        }
    }
}
impl RemoveTagsFromStreamInput {
    ...
    fn body(&self) -> RemoveTagsFromStreamInputBody {
        RemoveTagsFromStreamInputBody {
            tag_keys: &self.tag_keys,
            stream_name: &self.stream_name,
        }
    }
...
pub mod split_shard_input {
    ...
    use crate::operation::SplitShard;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<SplitShard, ()> {
            let op = SplitShard::new(SplitShardInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("SplitShard", "kinesis"),
            )
        }
    }
}
impl SplitShardInput {
    ...
    fn body(&self) -> SplitShardInputBody {
        SplitShardInputBody {
            shard_to_split: &self.shard_to_split,
            new_starting_hash_key: &self.new_starting_hash_key,
            stream_name: &self.stream_name,
...
pub mod start_stream_encryption_input {
    ...
    use crate::model::EncryptionType;
    use crate::operation::StartStreamEncryption;
    /// A builder for [`StartStreamEncryptionInput`](crate::input::StartStreamEncryptionInput)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        stream_name: ::std::option::Option<::std::string::String>,
        encryption_type: ::std::option::Option<EncryptionType>,
    ...
    impl Builder {
        ...
        pub fn encryption_type(mut self, inp: EncryptionType) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<StartStreamEncryption, ()> {
            let op = StartStreamEncryption::new(StartStreamEncryptionInput {
                stream_name: self.stream_name,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("StartStreamEncryption", "kinesis"),
            )
        }
    }
}
impl StartStreamEncryptionInput {
    ...
    fn body(&self) -> StartStreamEncryptionInputBody {
        StartStreamEncryptionInputBody {
            stream_name: &self.stream_name,
            encryption_type: &self.encryption_type,
            key_id: &self.key_id,
        }
...
pub mod stop_stream_encryption_input {
    ...
    use crate::model::EncryptionType;
    use crate::operation::StopStreamEncryption;
    ...
    impl Builder {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<StopStreamEncryption, ()> {
            let op = StopStreamEncryption::new(StopStreamEncryptionInput {
                stream_name: self.stream_name,
                encryption_type: self.encryption_type,
                key_id: self.key_id,
            });
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("StopStreamEncryption", "kinesis"),
            )
        }
    }
}
impl StopStreamEncryptionInput {
    ...
    fn body(&self) -> StopStreamEncryptionInputBody {
        StopStreamEncryptionInputBody {
            stream_name: &self.stream_name,
            encryption_type: &self.encryption_type,
            key_id: &self.key_id,
        }
...
/// See [`SubscribeToShardInput`](crate::input::SubscribeToShardInput)
pub mod subscribe_to_shard_input {

    use crate::input::SubscribeToShardInput;
    use crate::model::StartingPosition;
    use crate::operation::SubscribeToShard;
    /// A builder for [`SubscribeToShardInput`](crate::input::SubscribeToShardInput)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        shard_id: ::std::option::Option<::std::string::String>,
        starting_position: ::std::option::Option<StartingPosition>,
        consumer_arn: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        ...
        /// <p></p>
        pub fn starting_position(mut self, inp: StartingPosition) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<SubscribeToShard, ()> {
            let op = SubscribeToShard::new(SubscribeToShardInput {
                shard_id: self.shard_id,
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("SubscribeToShard", "kinesis"),
            )
        }
    }
}
impl SubscribeToShardInput {
    ...
    fn body(&self) -> SubscribeToShardInputBody {
        SubscribeToShardInputBody {
            shard_id: &self.shard_id,
            starting_position: &self.starting_position,
            consumer_arn: &self.consumer_arn,
        }
...
pub mod update_shard_count_input {
    ...
    use crate::model::ScalingType;
    use crate::operation::UpdateShardCount;
    /// A builder for [`UpdateShardCountInput`](crate::input::UpdateShardCountInput)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        scaling_type: ::std::option::Option<ScalingType>,
        stream_name: ::std::option::Option<::std::string::String>,
        target_shard_count: ::std::option::Option<i32>,
    }
    impl Builder {
        /// <p>The scaling type. Uniform scaling creates shards of equal size.</p>
        pub fn scaling_type(mut self, inp: ScalingType) -> Self {
        ...
        pub fn build(
            self,
            _config: &crate::config::Config,
        ) -> ::smithy_http::operation::Operation<UpdateShardCount, ()> {
            let op = UpdateShardCount::new(UpdateShardCountInput {
            ...
            ::smithy_http::operation::Operation::new(request, op).with_metadata(
                ::smithy_http::operation::Metadata::new("UpdateShardCount", "kinesis"),
            )
        }
    }
}
impl UpdateShardCountInput {
    ...
    fn body(&self) -> UpdateShardCountInputBody {
        UpdateShardCountInputBody {
            scaling_type: &self.scaling_type,
            stream_name: &self.stream_name,
            target_shard_count: &self.target_shard_count,
        }
...
pub struct SubscribeToShardInput {
    ...
    /// <p></p>
    pub starting_position: ::std::option::Option<StartingPosition>,
    /// <p>For this parameter, use the value you obtained when you called <a>RegisterStreamConsumer</a>.</p>
...
pub struct StopStreamEncryptionInput {
    ...
    pub stream_name: ::std::option::Option<::std::string::String>,
    /// <p>The encryption type. The only valid value is <code>KMS</code>.</p>
    pub encryption_type: ::std::option::Option<EncryptionType>,
    /// <p>The GUID for the customer-managed AWS KMS key to use for encryption. This value can
    /// be a globally unique identifier, a fully specified Amazon Resource Name (ARN) to either
    /// an alias or a key, or an alias name prefixed by "alias/".You can also use a master key
    /// owned by Kinesis Data Streams by specifying the alias
...
pub struct ListStreamConsumersInput {
    ...
    /// two streams you want to list the consumers for. </p>
    /// <p>You can't specify this parameter if you specify the NextToken parameter. </p>
    pub stream_creation_timestamp: ::std::option::Option<Instant>,
    /// <p>The ARN of the Kinesis data stream for which you want to list the registered
    /// consumers. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams">Amazon Resource Names (ARNs) and AWS Service Namespaces</a>.</p>
    pub stream_arn: ::std::option::Option<::std::string::String>,
    /// <p>The maximum number of consumers that you want a single call of
...
pub struct ListShardsInput {
    ...
    pub shard_filter: ::std::option::Option<ShardFilter>,
    /// <p>The name of the data stream whose shards you want to list. </p>
    /// <p>You cannot specify this parameter if you specify the <code>NextToken</code>
    /// parameter.</p>
    pub stream_name: ::std::option::Option<::std::string::String>,
...
pub struct GetShardIteratorInput {
    ...
    /// </li>
    /// </ul>
    pub shard_iterator_type: ::std::option::Option<ShardIteratorType>,
    /// <p>The shard ID of the Kinesis Data Streams shard to get the iterator for.</p>
    pub shard_id: ::std::option::Option<::std::string::String>,
    /// <p>The sequence number of the data record in the shard from which to start reading.
    /// Used with shard iterator type AT_SEQUENCE_NUMBER and AFTER_SEQUENCE_NUMBER.</p>
...
pub struct EnableEnhancedMonitoringInput {
    ...
    /// Kinesis Data Streams Service with Amazon CloudWatch</a> in the <i>Amazon
    /// Kinesis Data Streams Developer Guide</i>.</p>
    pub shard_level_metrics: ::std::option::Option<::std::vec::Vec<MetricsName>>,
}
