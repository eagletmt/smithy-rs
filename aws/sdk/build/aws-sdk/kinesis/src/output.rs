...
use crate::model::ChildShard;
use crate::model::Consumer;
use crate::model::ConsumerDescription;
use crate::model::EncryptionType;
use crate::model::MetricsName;
use crate::model::PutRecordsResultEntry;
use crate::model::Record;
use crate::model::Shard;
use crate::model::StreamDescription;
use crate::model::StreamDescriptionSummary;
use crate::model::SubscribeToShardEventStream;
use crate::model::Tag;
#[non_exhaustive]
...
pub mod update_shard_count_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> UpdateShardCountOutput {
...
pub struct SubscribeToShardOutput {
    ...
    pub event_stream: ::std::option::Option<SubscribeToShardEventStream>,
}
...
pub mod subscribe_to_shard_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        event_stream: ::std::option::Option<SubscribeToShardEventStream>,
    }
    impl Builder {
        /// <p>The event stream that your consumer can use to read records from the shard.</p>
        pub fn event_stream(mut self, inp: SubscribeToShardEventStream) -> Self {
        ...
        pub fn build(self) -> SubscribeToShardOutput {
...
pub mod stop_stream_encryption_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> StopStreamEncryptionOutput {
...
pub mod start_stream_encryption_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> StartStreamEncryptionOutput {
...
pub mod split_shard_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> SplitShardOutput {
            SplitShardOutput {}
        }
    }
}
...
pub mod remove_tags_from_stream_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> RemoveTagsFromStreamOutput {
...
pub struct RegisterStreamConsumerOutput {
    ...
    pub consumer: ::std::option::Option<Consumer>,
}
...
pub mod register_stream_consumer_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        consumer: ::std::option::Option<Consumer>,
    }
    impl Builder {
        /// <p>An object that represents the details of the consumer you registered. When you
        /// register a consumer, it gets an ARN that is generated by Kinesis Data Streams.</p>
        pub fn consumer(mut self, inp: Consumer) -> Self {
        ...
        pub fn build(self) -> RegisterStreamConsumerOutput {
...
pub struct PutRecordsOutput {
    ...
    pub records: ::std::option::Option<::std::vec::Vec<PutRecordsResultEntry>>,
...
pub mod put_records_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        records: ::std::option::Option<::std::vec::Vec<PutRecordsResultEntry>>,
    ...
    impl Builder {
        ...
        /// that fails to be added to a stream includes <code>ErrorCode</code> and
        /// <code>ErrorMessage</code> in the result.</p>
        pub fn records(mut self, inp: ::std::vec::Vec<PutRecordsResultEntry>) -> Self {
...
pub mod put_record_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> PutRecordOutput {
            PutRecordOutput {
...
pub mod merge_shards_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> MergeShardsOutput {
            MergeShardsOutput {}
        }
    }
}
...
pub mod list_tags_for_stream_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ListTagsForStreamOutput {
...
pub struct ListStreamConsumersOutput {
    ...
    pub consumers: ::std::option::Option<::std::vec::Vec<Consumer>>,
...
pub mod list_stream_consumers_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        consumers: ::std::option::Option<::std::vec::Vec<Consumer>>,
        next_token: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        /// <p>An array of JSON objects. Each object represents one registered consumer.</p>
        pub fn consumers(mut self, inp: ::std::vec::Vec<Consumer>) -> Self {
...
pub struct ListShardsOutput {
    ...
    pub shards: ::std::option::Option<::std::vec::Vec<Shard>>,
}
...
pub mod list_shards_output {
    ...
    pub struct Builder {
        next_token: ::std::option::Option<::std::string::String>,
        shards: ::std::option::Option<::std::vec::Vec<Shard>>,
    }
    impl Builder {
        /// <p>When the number of shards in the data stream is greater than the default value for
        /// the <code>MaxResults</code> parameter, or if you explicitly specify a value for
        ...
        /// object also contains the starting and ending hash keys and the starting and ending
        /// sequence numbers for the shard.</p>
        pub fn shards(mut self, inp: ::std::vec::Vec<Shard>) -> Self {
...
pub mod increase_stream_retention_period_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> IncreaseStreamRetentionPeriodOutput {
...
pub struct GetRecordsOutput {
    ...
    pub records: ::std::option::Option<::std::vec::Vec<Record>>,
    ...
    pub child_shards: ::std::option::Option<::std::vec::Vec<ChildShard>>,
}
...
pub mod get_records_output {
    ...
    pub struct Builder {
        ...
        records: ::std::option::Option<::std::vec::Vec<Record>>,
        millis_behind_latest: ::std::option::Option<i64>,
        child_shards: ::std::option::Option<::std::vec::Vec<ChildShard>>,
    }
    impl Builder {
        /// <p>The next position in the shard from which to start sequentially reading data
        /// records. If set to <code>null</code>, the shard has been closed and the requested
        ...
        /// <p>The data records retrieved from the shard.</p>
        pub fn records(mut self, inp: ::std::vec::Vec<Record>) -> Self {
            self.records = Some(inp);
            self
        }
        /// <p>The number of milliseconds the <a>GetRecords</a> response is from the
        ...
        pub fn child_shards(mut self, inp: ::std::vec::Vec<ChildShard>) -> Self {
...
pub struct EnableEnhancedMonitoringOutput {
    ...
    /// the operation.</p>
    pub desired_shard_level_metrics: ::std::option::Option<::std::vec::Vec<MetricsName>>,
    /// <p>The name of the Kinesis data stream.</p>
    pub stream_name: ::std::option::Option<::std::string::String>,
    /// <p>Represents the current state of the metrics that are in the enhanced state before
    /// the operation.</p>
    pub current_shard_level_metrics: ::std::option::Option<::std::vec::Vec<MetricsName>>,
}
...
pub mod enable_enhanced_monitoring_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        desired_shard_level_metrics: ::std::option::Option<::std::vec::Vec<MetricsName>>,
        stream_name: ::std::option::Option<::std::string::String>,
        current_shard_level_metrics: ::std::option::Option<::std::vec::Vec<MetricsName>>,
    }
    impl Builder {
        /// <p>Represents the list of all the metrics that would be in the enhanced state after
        /// the operation.</p>
        pub fn desired_shard_level_metrics(mut self, inp: ::std::vec::Vec<MetricsName>) -> Self {
        ...
        /// <p>Represents the current state of the metrics that are in the enhanced state before
        /// the operation.</p>
        pub fn current_shard_level_metrics(mut self, inp: ::std::vec::Vec<MetricsName>) -> Self {
...
pub struct DescribeStreamSummaryOutput {
    ...
    /// stream.</p>
    pub stream_description_summary: ::std::option::Option<StreamDescriptionSummary>,
}
...
pub mod describe_stream_summary_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        stream_description_summary: ::std::option::Option<StreamDescriptionSummary>,
    }
    impl Builder {
        /// <p>A <a>StreamDescriptionSummary</a> containing information about the
        /// stream.</p>
        pub fn stream_description_summary(mut self, inp: StreamDescriptionSummary) -> Self {
        ...
        pub fn build(self) -> DescribeStreamSummaryOutput {
...
pub struct DescribeStreamConsumerOutput {
    ...
    pub consumer_description: ::std::option::Option<ConsumerDescription>,
}
...
pub mod describe_stream_consumer_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        consumer_description: ::std::option::Option<ConsumerDescription>,
    }
    impl Builder {
        /// <p>An object that represents the details of the consumer.</p>
        pub fn consumer_description(mut self, inp: ConsumerDescription) -> Self {
        ...
        pub fn build(self) -> DescribeStreamConsumerOutput {
...
pub struct DescribeStreamOutput {
    ...
    /// available.</p>
    pub stream_description: ::std::option::Option<StreamDescription>,
}
...
pub mod describe_stream_output {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        stream_description: ::std::option::Option<StreamDescription>,
    }
    impl Builder {
        /// <p>The current status of the stream, the stream Amazon Resource Name (ARN), an array
        /// of shard objects that comprise the stream, and whether there are more shards
        /// available.</p>
        pub fn stream_description(mut self, inp: StreamDescription) -> Self {
...
pub mod deregister_stream_consumer_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DeregisterStreamConsumerOutput {
...
pub mod delete_stream_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DeleteStreamOutput {
            DeleteStreamOutput {}
        }
    }
}
...
pub mod decrease_stream_retention_period_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> DecreaseStreamRetentionPeriodOutput {
...
pub mod add_tags_to_stream_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> AddTagsToStreamOutput {
