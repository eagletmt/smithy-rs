...
pub struct DisableEnhancedMonitoringInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shard_level_metrics: &'a ::std::option::Option<::std::vec::Vec<MetricsName>>,
...
pub struct GetShardIteratorInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shard_iterator_type: &'a ::std::option::Option<ShardIteratorType>,
    ...
    pub timestamp: &'a ::std::option::Option<Instant>,
...
pub struct ListShardsInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(serialize_with = "crate::serde_util::stdoptionoptioninstant_epoch_seconds_ser")]
    pub stream_creation_timestamp: &'a ::std::option::Option<Instant>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shard_filter: &'a ::std::option::Option<ShardFilter>,
...
pub struct PutRecordInputBody<'a> {
    ...
    pub data: &'a ::std::option::Option<Blob>,
}
...
pub struct PutRecordsInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub records: &'a ::std::option::Option<::std::vec::Vec<PutRecordsRequestEntry>>,
...
pub struct StartStreamEncryptionInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub encryption_type: &'a ::std::option::Option<EncryptionType>,
...
pub struct SubscribeToShardInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub starting_position: &'a ::std::option::Option<StartingPosition>,
...
pub struct UpdateShardCountInputBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scaling_type: &'a ::std::option::Option<ScalingType>,
    /// <p>The name of the stream.</p>
    #[serde(rename = "StreamName")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stream_name: &'a ::std::option::Option<::std::string::String>,
