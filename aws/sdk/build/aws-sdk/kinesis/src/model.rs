...
impl SubscribeToShardEventStream {
    pub fn as_internal_failure_exception(&self) -> Option<&crate::error::InternalFailureError> {
        if let SubscribeToShardEventStream::InternalFailureException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_internal_failure_exception(&self) -> bool {
        self.as_internal_failure_exception().is_some()
    }
    pub fn as_kms_access_denied_exception(&self) -> Option<&crate::error::KMSAccessDeniedError> {
        if let SubscribeToShardEventStream::KmsAccessDeniedException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_kms_access_denied_exception(&self) -> bool {
        self.as_kms_access_denied_exception().is_some()
    }
    pub fn as_kms_disabled_exception(&self) -> Option<&crate::error::KMSDisabledError> {
        if let SubscribeToShardEventStream::KmsDisabledException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_kms_disabled_exception(&self) -> bool {
        self.as_kms_disabled_exception().is_some()
    }
    pub fn as_kms_invalid_state_exception(&self) -> Option<&crate::error::KMSInvalidStateError> {
        if let SubscribeToShardEventStream::KmsInvalidStateException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_kms_invalid_state_exception(&self) -> bool {
        self.as_kms_invalid_state_exception().is_some()
    }
    pub fn as_kms_not_found_exception(&self) -> Option<&crate::error::KMSNotFoundError> {
        if let SubscribeToShardEventStream::KmsNotFoundException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_kms_not_found_exception(&self) -> bool {
        self.as_kms_not_found_exception().is_some()
    }
    pub fn as_kms_opt_in_required(&self) -> Option<&crate::error::KMSOptInRequired> {
        if let SubscribeToShardEventStream::KmsOptInRequired(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_kms_opt_in_required(&self) -> bool {
        self.as_kms_opt_in_required().is_some()
    }
    pub fn as_kms_throttling_exception(&self) -> Option<&crate::error::KMSThrottlingError> {
        if let SubscribeToShardEventStream::KmsThrottlingException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_kms_throttling_exception(&self) -> bool {
        self.as_kms_throttling_exception().is_some()
    }
    pub fn as_resource_in_use_exception(&self) -> Option<&crate::error::ResourceInUseError> {
        if let SubscribeToShardEventStream::ResourceInUseException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_resource_in_use_exception(&self) -> bool {
        self.as_resource_in_use_exception().is_some()
    }
    pub fn as_resource_not_found_exception(&self) -> Option<&crate::error::ResourceNotFoundError> {
        if let SubscribeToShardEventStream::ResourceNotFoundException(val) = &self {
            Some(&val)
        } else {
            None
        }
    ...
    pub fn is_resource_not_found_exception(&self) -> bool {
        self.as_resource_not_found_exception().is_some()
    }
    pub fn as_subscribe_to_shard_event(&self) -> Option<&crate::model::SubscribeToShardEvent> {
    ...
    pub fn is_subscribe_to_shard_event(&self) -> bool {
        self.as_subscribe_to_shard_event().is_some()
    }
}
