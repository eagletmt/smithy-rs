...
pub mod subscribe_to_shard_event {
    ...
    use crate::model::SubscribeToShardEvent;
    ...
    impl Builder {
        ...
        /// <code>ContinuationSequenceNumber</code> for checkpointing because it captures your
        /// shard progress even when no data is written to the shard.</p>
        pub fn continuation_sequence_number(
            mut self,
        ...
        pub fn build(self) -> SubscribeToShardEvent {
...
pub struct ChildShard {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub hash_key_range: ::std::option::Option<HashKeyRange>,
}
/// See [`ChildShard`](crate::model::ChildShard)
pub mod child_shard {

    use crate::model::ChildShard;
    use crate::model::HashKeyRange;
    ...
    pub struct Builder {
        ...
        hash_key_range: ::std::option::Option<HashKeyRange>,
    }
    impl Builder {
        ...
        /// <p>The range of possible hash key values for the shard, which is a set of ordered
        /// contiguous positive integers.</p>
        pub fn hash_key_range(mut self, inp: HashKeyRange) -> Self {
...
pub mod hash_key_range {
    ...
    impl Builder {
        ...
        pub fn build(self) -> HashKeyRange {
            HashKeyRange {
...
pub struct Record {
    ...
    #[serde(default)]
    pub approximate_arrival_timestamp: ::std::option::Option<Instant>,
...
pub mod record {
    ...
    pub struct Builder {
        ...
        approximate_arrival_timestamp: ::std::option::Option<Instant>,
    ...
    impl Builder {
        ...
        /// <p>The approximate time that the record was inserted into the stream.</p>
        pub fn approximate_arrival_timestamp(mut self, inp: Instant) -> Self {
...
pub struct StartingPosition {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub r#type: ::std::option::Option<ShardIteratorType>,
}
...
pub mod starting_position {
    ...
    pub struct Builder {
        ...
        sequence_number: ::std::option::Option<::std::string::String>,
        r#type: ::std::option::Option<ShardIteratorType>,
    }
    impl Builder {
        /// <p>The time stamp of the data record from which to start reading. To specify a time
        /// stamp, set <code>StartingPosition</code> to <code>Type AT_TIMESTAMP</code>. A time stamp
...
pub struct Consumer {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub consumer_status: ::std::option::Option<ConsumerStatus>,
    /// <p></p>
    ...
    #[serde(deserialize_with = "crate::serde_util::stdoptionoptioninstant_epoch_seconds_deser")]
    #[serde(default)]
    pub consumer_creation_timestamp: ::std::option::Option<Instant>,
}
/// See [`Consumer`](crate::model::Consumer)
pub mod consumer {

    use crate::model::Consumer;
    use crate::model::ConsumerStatus;
    use smithy_types::Instant;
    ...
    pub struct Builder {
        ...
        consumer_status: ::std::option::Option<ConsumerStatus>,
        consumer_creation_timestamp: ::std::option::Option<Instant>,
    }
    impl Builder {
        /// <p>The name of the consumer is something you choose when you register the
        /// consumer.</p>
        ...
        /// <p>A consumer can't read data while in the <code>CREATING</code> or <code>DELETING</code>
        /// states.</p>
        pub fn consumer_status(mut self, inp: ConsumerStatus) -> Self {
            self.consumer_status = Some(inp);
            self
        }
        /// <p></p>
        pub fn consumer_creation_timestamp(mut self, inp: Instant) -> Self {
...
pub mod put_records_request_entry {
    ...
    impl Builder {
        ...
        pub fn build(self) -> PutRecordsRequestEntry {
...
pub struct Shard {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub sequence_number_range: ::std::option::Option<SequenceNumberRange>,
...
pub mod shard {
    ...
    use crate::model::HashKeyRange;
    use crate::model::SequenceNumberRange;
    use crate::model::Shard;
    /// A builder for [`Shard`](crate::model::Shard)
    #[non_exhaustive]
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        sequence_number_range: ::std::option::Option<SequenceNumberRange>,
        shard_id: ::std::option::Option<::std::string::String>,
        hash_key_range: ::std::option::Option<HashKeyRange>,
    ...
    impl Builder {
        /// <p>The range of possible sequence numbers for the shard.</p>
        pub fn sequence_number_range(mut self, inp: SequenceNumberRange) -> Self {
...
pub mod shard_filter {
    ...
    pub struct Builder {
        shard_id: ::std::option::Option<::std::string::String>,
        timestamp: ::std::option::Option<Instant>,
        r#type: ::std::option::Option<ShardFilterType>,
    }
    impl Builder {
        pub fn shard_id(mut self, inp: impl Into<::std::string::String>) -> Self {
            self.shard_id = Some(inp.into());
        ...
        pub fn r#type(mut self, inp: ShardFilterType) -> Self {
            self.r#type = Some(inp);
            self
        }
...
pub struct StreamDescriptionSummary {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub stream_status: ::std::option::Option<StreamStatus>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    pub enhanced_monitoring: ::std::option::Option<::std::vec::Vec<EnhancedMetrics>>,
}
/// See [`StreamDescriptionSummary`](crate::model::StreamDescriptionSummary)
pub mod stream_description_summary {

    use crate::model::EncryptionType;
    use crate::model::EnhancedMetrics;
    ...
    pub struct Builder {
        ...
        enhanced_monitoring: ::std::option::Option<::std::vec::Vec<EnhancedMetrics>>,
    }
    impl Builder {
        /// <p>The GUID for the customer-managed AWS KMS key to use for encryption. This value can
        /// be a globally unique identifier, a fully specified ARN to either an alias or a key, or
        ...
        /// </li>
        /// </ul>
        pub fn stream_status(mut self, inp: StreamStatus) -> Self {
        ...
        /// <p>Represents the current enhanced monitoring settings of the stream.</p>
        pub fn enhanced_monitoring(mut self, inp: ::std::vec::Vec<EnhancedMetrics>) -> Self {
        ...
        pub fn build(self) -> StreamDescriptionSummary {
...
pub mod consumer_description {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ConsumerDescription {
            ConsumerDescription {
                stream_arn: self.stream_arn,
                consumer_name: self.consumer_name,
                consumer_arn: self.consumer_arn,
