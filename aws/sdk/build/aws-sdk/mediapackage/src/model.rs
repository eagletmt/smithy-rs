...
pub struct HlsPackage {
    ...
    #[serde(default)]
    pub ad_triggers: std::option::Option<std::vec::Vec<crate::model::__AdTriggersElement>>,
...
pub mod hls_package {
    ...
    pub struct Builder {
        ...
        pub(crate) ad_triggers:
            std::option::Option<std::vec::Vec<crate::model::__AdTriggersElement>>,
    ...
    impl Builder {
        ...
        pub fn ad_triggers(mut self, inp: impl Into<crate::model::__AdTriggersElement>) -> Self {
        ...
        pub fn set_ad_triggers(
            mut self,
            inp: std::option::Option<std::vec::Vec<crate::model::__AdTriggersElement>>,
        ) -> Self {
...
impl std::convert::From<&str> for __AdTriggersElement {
    fn from(s: &str) -> Self {
        match s {
            "BREAK" => __AdTriggersElement::Break,
            "DISTRIBUTOR_ADVERTISEMENT" => __AdTriggersElement::DistributorAdvertisement,
            ...
            "PROVIDER_ADVERTISEMENT" => __AdTriggersElement::ProviderAdvertisement,
            "PROVIDER_OVERLAY_PLACEMENT_OPPORTUNITY" => {
                __AdTriggersElement::ProviderOverlayPlacementOpportunity
            }
            "PROVIDER_PLACEMENT_OPPORTUNITY" => __AdTriggersElement::ProviderPlacementOpportunity,
            "SPLICE_INSERT" => __AdTriggersElement::SpliceInsert,
            other => __AdTriggersElement::Unknown(other.to_owned()),
        }
    }
}
impl std::str::FromStr for __AdTriggersElement {
    type Err = std::convert::Infallible;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(__AdTriggersElement::from(s))
    }
}
impl __AdTriggersElement {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            __AdTriggersElement::ProviderPlacementOpportunity => "PROVIDER_PLACEMENT_OPPORTUNITY",
            __AdTriggersElement::SpliceInsert => "SPLICE_INSERT",
            __AdTriggersElement::Unknown(s) => s.as_ref(),
        }
    }
}
impl AsRef<str> for __AdTriggersElement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl<'de> serde::Deserialize<'de> for __AdTriggersElement {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub struct DashPackage {
    ...
    #[serde(default)]
    pub period_triggers: std::option::Option<std::vec::Vec<crate::model::__PeriodTriggersElement>>,
...
pub mod dash_package {
    ...
    pub struct Builder {
        ...
        pub(crate) period_triggers:
            std::option::Option<std::vec::Vec<crate::model::__PeriodTriggersElement>>,
    ...
    impl Builder {
        ...
        pub fn period_triggers(
            mut self,
            inp: impl Into<crate::model::__PeriodTriggersElement>,
        ) -> Self {
        ...
        pub fn set_period_triggers(
            mut self,
            inp: std::option::Option<std::vec::Vec<crate::model::__PeriodTriggersElement>>,
        ) -> Self {
...
pub enum __PeriodTriggersElement {
    Ads,
    Unknown(String),
}
impl std::convert::From<&str> for __PeriodTriggersElement {
    fn from(s: &str) -> Self {
        match s {
            "ADS" => __PeriodTriggersElement::Ads,
            other => __PeriodTriggersElement::Unknown(other.to_owned()),
        }
    }
}
impl std::str::FromStr for __PeriodTriggersElement {
    type Err = std::convert::Infallible;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(__PeriodTriggersElement::from(s))
    }
}
impl __PeriodTriggersElement {
    pub fn as_str(&self) -> &str {
        match self {
            __PeriodTriggersElement::Ads => "ADS",
            __PeriodTriggersElement::Unknown(s) => s.as_ref(),
        }
    }
}
impl AsRef<str> for __PeriodTriggersElement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl<'de> serde::Deserialize<'de> for __PeriodTriggersElement {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
