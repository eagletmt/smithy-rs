...
pub fn serialize_structure_create_input_input(
    ...
    if let Some(var_55) = &input.destinations {
        ...
        for item_57 in var_55 {
            ...
            crate::json_ser::serialize_structure_input_destination_request(&mut object_58, item_57);
            object_58.finish();
        }
        array_56.finish();
    }
...
pub fn serialize_structure_create_input_security_group_input(
    ...
    if let Some(var_88) = &input.whitelist_rules {
        ...
        for item_90 in var_88 {
            ...
            crate::json_ser::serialize_structure_input_whitelist_rule_cidr(&mut object_91, item_90);
            object_91.finish();
        }
        array_89.finish();
    }
...
pub fn serialize_structure_update_input_input(
    ...
    if let Some(var_152) = &input.input_devices {
        ...
        for item_154 in var_152 {
            ...
            crate::json_ser::serialize_structure_input_device_request(&mut object_155, item_154);
            object_155.finish();
        }
        array_153.finish();
    }
    ...
    if let Some(var_165) = &input.sources {
        ...
        for item_167 in var_165 {
            ...
            crate::json_ser::serialize_structure_input_source_request(&mut object_168, item_167);
            object_168.finish();
        }
        array_166.finish();
    }
...
pub fn serialize_structure_remix_settings(
    ...
    if let Some(var_416) = &input.channel_mappings {
        ...
        for item_418 in var_416 {
            ...
            crate::json_ser::serialize_structure_audio_channel_mapping(&mut object_419, item_418);
            object_419.finish();
        }
        array_417.finish();
    }
...
pub fn serialize_structure_archive_group_settings(
    ...
    if let Some(var_600) = &input.archive_cdn_settings {
        let mut object_601 = object.key("archiveCdnSettings").start_object();
        crate::json_ser::serialize_structure_archive_cdn_settings(&mut object_601, var_600);
        object_601.finish();
    }
    if let Some(var_602) = &input.destination {
        let mut object_603 = object.key("destination").start_object();
        crate::json_ser::serialize_structure_output_location_ref(&mut object_603, var_602);
        object_603.finish();
    }
...
pub fn serialize_structure_frame_capture_group_settings(
    ...
    if let Some(var_604) = &input.destination {
        let mut object_605 = object.key("destination").start_object();
        crate::json_ser::serialize_structure_output_location_ref(&mut object_605, var_604);
        object_605.finish();
    }
    if let Some(var_606) = &input.frame_capture_cdn_settings {
        let mut object_607 = object.key("frameCaptureCdnSettings").start_object();
        crate::json_ser::serialize_structure_frame_capture_cdn_settings(&mut object_607, var_606);
        object_607.finish();
    }
}
...
pub fn serialize_structure_hls_group_settings(
    ...
    if let Some(var_608) = &input.ad_markers {
        let mut array_609 = object.key("adMarkers").start_array();
        for item_610 in var_608 {
            array_609.value().string(item_610.as_str());
        }
        array_609.finish();
    }
    if let Some(var_611) = &input.base_url_content {
        object.key("baseUrlContent").string(var_611);
    }
    if let Some(var_612) = &input.base_url_content1 {
        object.key("baseUrlContent1").string(var_612);
    }
    if let Some(var_613) = &input.base_url_manifest {
        object.key("baseUrlManifest").string(var_613);
    }
    if let Some(var_614) = &input.base_url_manifest1 {
        object.key("baseUrlManifest1").string(var_614);
    }
    if let Some(var_615) = &input.caption_language_mappings {
        let mut array_616 = object.key("captionLanguageMappings").start_array();
    ...
    if let Some(var_619) = &input.caption_language_setting {
        object
            .key("captionLanguageSetting")
            .string(var_619.as_str());
    }
    if let Some(var_620) = &input.client_cache {
        object.key("clientCache").string(var_620.as_str());
    }
    if let Some(var_621) = &input.codec_specification {
        object.key("codecSpecification").string(var_621.as_str());
    }
    if let Some(var_622) = &input.constant_iv {
        object.key("constantIv").string(var_622);
    }
    if let Some(var_623) = &input.destination {
        let mut object_624 = object.key("destination").start_object();
        crate::json_ser::serialize_structure_output_location_ref(&mut object_624, var_623);
        object_624.finish();
    }
    if let Some(var_625) = &input.directory_structure {
        object.key("directoryStructure").string(var_625.as_str());
    }
    if let Some(var_626) = &input.discontinuity_tags {
        object.key("discontinuityTags").string(var_626.as_str());
    }
    if let Some(var_627) = &input.encryption_type {
        object.key("encryptionType").string(var_627.as_str());
    }
    if let Some(var_628) = &input.hls_cdn_settings {
        let mut object_629 = object.key("hlsCdnSettings").start_object();
        crate::json_ser::serialize_structure_hls_cdn_settings(&mut object_629, var_628);
        object_629.finish();
    }
    if let Some(var_630) = &input.hls_id3_segment_tagging {
        object.key("hlsId3SegmentTagging").string(var_630.as_str());
    }
    if let Some(var_631) = &input.i_frame_only_playlists {
        object.key("iFrameOnlyPlaylists").string(var_631.as_str());
    }
    if let Some(var_632) = &input.incomplete_segment_behavior {
        object
    ...
    if let Some(var_633) = &input.input_loss_action {
        object.key("inputLossAction").string(var_633.as_str());
    }
    if let Some(var_634) = &input.iv_in_manifest {
        object.key("ivInManifest").string(var_634.as_str());
    }
    if let Some(var_635) = &input.iv_source {
        object.key("ivSource").string(var_635.as_str());
    }
    object.key("keepSegments").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.keep_segments).into()),
    );
    if let Some(var_636) = &input.key_format {
        object.key("keyFormat").string(var_636);
    }
    if let Some(var_637) = &input.key_format_versions {
        object.key("keyFormatVersions").string(var_637);
    }
    if let Some(var_638) = &input.key_provider_settings {
        let mut object_639 = object.key("keyProviderSettings").start_object();
        crate::json_ser::serialize_structure_key_provider_settings(&mut object_639, var_638);
        object_639.finish();
    }
    if let Some(var_640) = &input.manifest_compression {
        object.key("manifestCompression").string(var_640.as_str());
    }
    if let Some(var_641) = &input.manifest_duration_format {
        object
    ...
    if let Some(var_642) = &input.mode {
        object.key("mode").string(var_642.as_str());
    }
    if let Some(var_643) = &input.output_selection {
        object.key("outputSelection").string(var_643.as_str());
    }
    if let Some(var_644) = &input.program_date_time {
        object.key("programDateTime").string(var_644.as_str());
    }
    object.key("programDateTimePeriod").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.program_date_time_period).into()),
    );
    if let Some(var_645) = &input.redundant_manifest {
        object.key("redundantManifest").string(var_645.as_str());
    }
    object.key("segmentLength").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.segment_length).into()),
    );
    if let Some(var_646) = &input.segmentation_mode {
        object.key("segmentationMode").string(var_646.as_str());
    }
    object.key("segmentsPerSubdirectory").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.segments_per_subdirectory).into()),
    );
    if let Some(var_647) = &input.stream_inf_resolution {
        object.key("streamInfResolution").string(var_647.as_str());
    }
    if let Some(var_648) = &input.timed_metadata_id3_frame {
        object.key("timedMetadataId3Frame").string(var_648.as_str());
    }
    ...
    if let Some(var_649) = &input.ts_file_mode {
        object.key("tsFileMode").string(var_649.as_str());
    }
}
...
pub fn serialize_structure_media_package_group_settings(
    ...
    if let Some(var_650) = &input.destination {
        ...
        crate::json_ser::serialize_structure_output_location_ref(&mut object_651, var_650);
        object_651.finish();
    }
}
...
pub fn serialize_structure_ms_smooth_group_settings(
    ...
    if let Some(var_652) = &input.acquisition_point_id {
        object.key("acquisitionPointId").string(var_652);
    }
    if let Some(var_653) = &input.audio_only_timecode_control {
        object
            .key("audioOnlyTimecodeControl")
            .string(var_653.as_str());
    }
    if let Some(var_654) = &input.certificate_mode {
        object.key("certificateMode").string(var_654.as_str());
    }
    object.key("connectionRetryInterval").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.connection_retry_interval).into()),
    );
    if let Some(var_655) = &input.destination {
        let mut object_656 = object.key("destination").start_object();
        crate::json_ser::serialize_structure_output_location_ref(&mut object_656, var_655);
        object_656.finish();
    }
    if let Some(var_657) = &input.event_id {
        object.key("eventId").string(var_657);
    }
    if let Some(var_658) = &input.event_id_mode {
        object.key("eventIdMode").string(var_658.as_str());
    }
    if let Some(var_659) = &input.event_stop_behavior {
        object.key("eventStopBehavior").string(var_659.as_str());
    }
    ...
    if let Some(var_661) = &input.segmentation_mode {
        object.key("segmentationMode").string(var_661.as_str());
    }
    object.key("sendDelayMs").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.send_delay_ms).into()),
    );
    if let Some(var_662) = &input.sparse_track_type {
        object.key("sparseTrackType").string(var_662.as_str());
    }
    if let Some(var_663) = &input.stream_manifest_behavior {
        object
            .key("streamManifestBehavior")
            .string(var_663.as_str());
    }
    if let Some(var_664) = &input.timestamp_offset {
        object.key("timestampOffset").string(var_664);
    }
    if let Some(var_665) = &input.timestamp_offset_mode {
        object.key("timestampOffsetMode").string(var_665.as_str());
    }
}
...
pub fn serialize_structure_rtmp_group_settings(
    ...
    if let Some(var_666) = &input.ad_markers {
        let mut array_667 = object.key("adMarkers").start_array();
        for item_668 in var_666 {
            array_667.value().string(item_668.as_str());
        }
        array_667.finish();
    }
    if let Some(var_669) = &input.authentication_scheme {
        object.key("authenticationScheme").string(var_669.as_str());
    }
    if let Some(var_670) = &input.cache_full_behavior {
        object.key("cacheFullBehavior").string(var_670.as_str());
    }
    object.key("cacheLength").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.cache_length).into()),
    );
    if let Some(var_671) = &input.caption_data {
        object.key("captionData").string(var_671.as_str());
    }
...
pub fn serialize_structure_output_settings(
    ...
    if let Some(var_675) = &input.archive_output_settings {
        let mut object_676 = object.key("archiveOutputSettings").start_object();
        crate::json_ser::serialize_structure_archive_output_settings(&mut object_676, var_675);
        object_676.finish();
    }
    if let Some(var_677) = &input.frame_capture_output_settings {
        let mut object_678 = object.key("frameCaptureOutputSettings").start_object();
    ...
    if let Some(var_679) = &input.hls_output_settings {
        let mut object_680 = object.key("hlsOutputSettings").start_object();
        crate::json_ser::serialize_structure_hls_output_settings(&mut object_680, var_679);
        object_680.finish();
    }
    if let Some(var_681) = &input.media_package_output_settings {
        let mut object_682 = object.key("mediaPackageOutputSettings").start_object();
    ...
    if let Some(var_683) = &input.ms_smooth_output_settings {
        let mut object_684 = object.key("msSmoothOutputSettings").start_object();
        crate::json_ser::serialize_structure_ms_smooth_output_settings(&mut object_684, var_683);
        object_684.finish();
    }
    if let Some(var_685) = &input.multiplex_output_settings {
        let mut object_686 = object.key("multiplexOutputSettings").start_object();
        crate::json_ser::serialize_structure_multiplex_output_settings(&mut object_686, var_685);
        object_686.finish();
    }
    if let Some(var_687) = &input.rtmp_output_settings {
        let mut object_688 = object.key("rtmpOutputSettings").start_object();
        crate::json_ser::serialize_structure_rtmp_output_settings(&mut object_688, var_687);
        object_688.finish();
    }
    if let Some(var_689) = &input.udp_output_settings {
        let mut object_690 = object.key("udpOutputSettings").start_object();
        crate::json_ser::serialize_structure_udp_output_settings(&mut object_690, var_689);
        object_690.finish();
    }
}
...
pub fn serialize_structure_frame_capture_settings(
    ...
    if let Some(var_691) = &input.capture_interval_units {
        object.key("captureIntervalUnits").string(var_691.as_str());
    }
}
...
pub fn serialize_structure_h264_settings(
    ...
    if let Some(var_692) = &input.adaptive_quantization {
        object.key("adaptiveQuantization").string(var_692.as_str());
    }
    if let Some(var_693) = &input.afd_signaling {
        object.key("afdSignaling").string(var_693.as_str());
    }
    object.key("bitrate").number(
        #[allow(clippy::useless_conversion)]
    ...
    if let Some(var_694) = &input.color_metadata {
        object.key("colorMetadata").string(var_694.as_str());
    }
    if let Some(var_695) = &input.color_space_settings {
        let mut object_696 = object.key("colorSpaceSettings").start_object();
        crate::json_ser::serialize_structure_h264_color_space_settings(&mut object_696, var_695);
        object_696.finish();
    }
    if let Some(var_697) = &input.entropy_encoding {
        object.key("entropyEncoding").string(var_697.as_str());
    }
    if let Some(var_698) = &input.filter_settings {
        let mut object_699 = object.key("filterSettings").start_object();
        crate::json_ser::serialize_structure_h264_filter_settings(&mut object_699, var_698);
        object_699.finish();
    }
    if let Some(var_700) = &input.fixed_afd {
        object.key("fixedAfd").string(var_700.as_str());
    }
    if let Some(var_701) = &input.flicker_aq {
        object.key("flickerAq").string(var_701.as_str());
    }
    if let Some(var_702) = &input.force_field_pictures {
        object.key("forceFieldPictures").string(var_702.as_str());
    }
    if let Some(var_703) = &input.framerate_control {
        object.key("framerateControl").string(var_703.as_str());
    }
    ...
    if let Some(var_704) = &input.gop_b_reference {
        object.key("gopBReference").string(var_704.as_str());
    }
    ...
    if let Some(var_705) = &input.gop_size_units {
        object.key("gopSizeUnits").string(var_705.as_str());
    }
    if let Some(var_706) = &input.level {
        object.key("level").string(var_706.as_str());
    }
    if let Some(var_707) = &input.look_ahead_rate_control {
        object.key("lookAheadRateControl").string(var_707.as_str());
    }
    object.key("maxBitrate").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.max_bitrate).into()),
    ...
    if let Some(var_708) = &input.par_control {
        object.key("parControl").string(var_708.as_str());
    }
    ...
    if let Some(var_709) = &input.profile {
        object.key("profile").string(var_709.as_str());
    }
    if let Some(var_710) = &input.quality_level {
        object.key("qualityLevel").string(var_710.as_str());
    }
    ...
    if let Some(var_712) = &input.scan_type {
        object.key("scanType").string(var_712.as_str());
    }
    if let Some(var_713) = &input.scene_change_detect {
        object.key("sceneChangeDetect").string(var_713.as_str());
    }
    ...
    if let Some(var_714) = &input.spatial_aq {
        object.key("spatialAq").string(var_714.as_str());
    }
    if let Some(var_715) = &input.subgop_length {
        object.key("subgopLength").string(var_715.as_str());
    }
    if let Some(var_716) = &input.syntax {
        object.key("syntax").string(var_716.as_str());
    }
    if let Some(var_717) = &input.temporal_aq {
        object.key("temporalAq").string(var_717.as_str());
    }
    if let Some(var_718) = &input.timecode_insertion {
        object.key("timecodeInsertion").string(var_718.as_str());
    }
}
...
pub fn serialize_structure_h265_settings(
    ...
    if let Some(var_721) = &input.alternative_transfer_function {
        object
    ...
    if let Some(var_723) = &input.color_space_settings {
        ...
        crate::json_ser::serialize_structure_h265_color_space_settings(&mut object_724, var_723);
        object_724.finish();
    }
    if let Some(var_725) = &input.filter_settings {
        let mut object_726 = object.key("filterSettings").start_object();
        crate::json_ser::serialize_structure_h265_filter_settings(&mut object_726, var_725);
        object_726.finish();
    }
    ...
    if let Some(var_729) = &input.gop_size_units {
        object.key("gopSizeUnits").string(var_729.as_str());
    }
    if let Some(var_730) = &input.level {
        object.key("level").string(var_730.as_str());
    }
    if let Some(var_731) = &input.look_ahead_rate_control {
        object.key("lookAheadRateControl").string(var_731.as_str());
    }
    object.key("maxBitrate").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.max_bitrate).into()),
    ...
    if let Some(var_732) = &input.profile {
        object.key("profile").string(var_732.as_str());
    }
    object.key("qvbrQualityLevel").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.qvbr_quality_level).into()),
    ...
    if let Some(var_734) = &input.scan_type {
        object.key("scanType").string(var_734.as_str());
    }
    if let Some(var_735) = &input.scene_change_detect {
        object.key("sceneChangeDetect").string(var_735.as_str());
    }
    object.key("slices").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.slices).into()),
    );
    if let Some(var_736) = &input.tier {
        object.key("tier").string(var_736.as_str());
    }
    if let Some(var_737) = &input.timecode_insertion {
        object.key("timecodeInsertion").string(var_737.as_str());
    }
}
...
pub fn serialize_structure_mpeg2_settings(
    ...
    if let Some(var_741) = &input.color_space {
        object.key("colorSpace").string(var_741.as_str());
    }
    if let Some(var_742) = &input.display_aspect_ratio {
        object.key("displayAspectRatio").string(var_742.as_str());
    }
    if let Some(var_743) = &input.filter_settings {
        let mut object_744 = object.key("filterSettings").start_object();
        crate::json_ser::serialize_structure_mpeg2_filter_settings(&mut object_744, var_743);
        object_744.finish();
    }
    if let Some(var_745) = &input.fixed_afd {
        object.key("fixedAfd").string(var_745.as_str());
    }
    object.key("framerateDenominator").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.framerate_denominator).into()),
    ...
    if let Some(var_746) = &input.gop_size_units {
        object.key("gopSizeUnits").string(var_746.as_str());
    }
    if let Some(var_747) = &input.scan_type {
        object.key("scanType").string(var_747.as_str());
    }
    if let Some(var_748) = &input.subgop_length {
        object.key("subgopLength").string(var_748.as_str());
    }
...
pub fn serialize_structure_failover_condition_settings(
    ...
    if let Some(var_750) = &input.audio_silence_settings {
        let mut object_751 = object.key("audioSilenceSettings").start_object();
    ...
    if let Some(var_752) = &input.input_loss_settings {
        let mut object_753 = object.key("inputLossSettings").start_object();
        crate::json_ser::serialize_structure_input_loss_failover_settings(&mut object_753, var_752);
        object_753.finish();
    }
    if let Some(var_754) = &input.video_black_settings {
        let mut object_755 = object.key("videoBlackSettings").start_object();
...
pub fn serialize_structure_audio_selector_settings(
    ...
    if let Some(var_756) = &input.audio_language_selection {
        let mut object_757 = object.key("audioLanguageSelection").start_object();
        crate::json_ser::serialize_structure_audio_language_selection(&mut object_757, var_756);
        object_757.finish();
    }
    if let Some(var_758) = &input.audio_pid_selection {
        let mut object_759 = object.key("audioPidSelection").start_object();
        crate::json_ser::serialize_structure_audio_pid_selection(&mut object_759, var_758);
        object_759.finish();
    }
    if let Some(var_760) = &input.audio_track_selection {
        let mut object_761 = object.key("audioTrackSelection").start_object();
        crate::json_ser::serialize_structure_audio_track_selection(&mut object_761, var_760);
        object_761.finish();
    }
}
...
pub fn serialize_structure_caption_selector_settings(
    ...
    if let Some(var_762) = &input.ancillary_source_settings {
        let mut object_763 = object.key("ancillarySourceSettings").start_object();
        crate::json_ser::serialize_structure_ancillary_source_settings(&mut object_763, var_762);
        object_763.finish();
    }
    if let Some(var_764) = &input.arib_source_settings {
        let mut object_765 = object.key("aribSourceSettings").start_object();
        crate::json_ser::serialize_structure_arib_source_settings(&mut object_765, var_764);
        object_765.finish();
    }
    if let Some(var_766) = &input.dvb_sub_source_settings {
        let mut object_767 = object.key("dvbSubSourceSettings").start_object();
        crate::json_ser::serialize_structure_dvb_sub_source_settings(&mut object_767, var_766);
        object_767.finish();
    }
    if let Some(var_768) = &input.embedded_source_settings {
        let mut object_769 = object.key("embeddedSourceSettings").start_object();
        crate::json_ser::serialize_structure_embedded_source_settings(&mut object_769, var_768);
        object_769.finish();
    }
    if let Some(var_770) = &input.scte20_source_settings {
        let mut object_771 = object.key("scte20SourceSettings").start_object();
        crate::json_ser::serialize_structure_scte20_source_settings(&mut object_771, var_770);
        object_771.finish();
    }
    if let Some(var_772) = &input.scte27_source_settings {
        let mut object_773 = object.key("scte27SourceSettings").start_object();
        crate::json_ser::serialize_structure_scte27_source_settings(&mut object_773, var_772);
        object_773.finish();
    }
    if let Some(var_774) = &input.teletext_source_settings {
        let mut object_775 = object.key("teletextSourceSettings").start_object();
        crate::json_ser::serialize_structure_teletext_source_settings(&mut object_775, var_774);
        object_775.finish();
    }
}
...
pub fn serialize_structure_video_selector_color_space_settings(
    ...
    if let Some(var_776) = &input.hdr10_settings {
        let mut object_777 = object.key("hdr10Settings").start_object();
        crate::json_ser::serialize_structure_hdr10_settings(&mut object_777, var_776);
        object_777.finish();
    }
}
...
pub fn serialize_structure_video_selector_settings(
    ...
    if let Some(var_778) = &input.video_selector_pid {
        let mut object_779 = object.key("videoSelectorPid").start_object();
        crate::json_ser::serialize_structure_video_selector_pid(&mut object_779, var_778);
        object_779.finish();
    }
    if let Some(var_780) = &input.video_selector_program_id {
        let mut object_781 = object.key("videoSelectorProgramId").start_object();
        crate::json_ser::serialize_structure_video_selector_program_id(&mut object_781, var_780);
        object_781.finish();
    }
}
...
pub fn serialize_structure_input_clipping_settings(
    ...
    if let Some(var_782) = &input.input_timecode_source {
        object.key("inputTimecodeSource").string(var_782.as_str());
    }
    if let Some(var_783) = &input.start_timecode {
        let mut object_784 = object.key("startTimecode").start_object();
        crate::json_ser::serialize_structure_start_timecode(&mut object_784, var_783);
        object_784.finish();
    }
    if let Some(var_785) = &input.stop_timecode {
        let mut object_786 = object.key("stopTimecode").start_object();
        crate::json_ser::serialize_structure_stop_timecode(&mut object_786, var_785);
        object_786.finish();
    }
}
...
pub fn serialize_structure_pipeline_pause_state_settings(
    ...
    if let Some(var_787) = &input.pipeline_id {
        object.key("pipelineId").string(var_787.as_str());
    }
}
...
pub fn serialize_structure_scte35_descriptor(
    ...
    if let Some(var_788) = &input.scte35_descriptor_settings {
        let mut object_789 = object.key("scte35DescriptorSettings").start_object();
        crate::json_ser::serialize_structure_scte35_descriptor_settings(&mut object_789, var_788);
        object_789.finish();
    }
}
...
pub fn serialize_structure_archive_cdn_settings(
    ...
    if let Some(var_790) = &input.archive_s3_settings {
        let mut object_791 = object.key("archiveS3Settings").start_object();
        crate::json_ser::serialize_structure_archive_s3_settings(&mut object_791, var_790);
        object_791.finish();
    }
}
...
pub fn serialize_structure_output_location_ref(
    ...
    if let Some(var_792) = &input.destination_ref_id {
        object.key("destinationRefId").string(var_792);
    }
}
...
pub fn serialize_structure_frame_capture_cdn_settings(
    ...
    if let Some(var_793) = &input.frame_capture_s3_settings {
        let mut object_794 = object.key("frameCaptureS3Settings").start_object();
        crate::json_ser::serialize_structure_frame_capture_s3_settings(&mut object_794, var_793);
        object_794.finish();
    }
}
...
pub fn serialize_structure_caption_language_mapping(
    ...
    if let Some(var_795) = &input.language_code {
        object.key("languageCode").string(var_795);
    }
    if let Some(var_796) = &input.language_description {
        object.key("languageDescription").string(var_796);
    }
}
...
pub fn serialize_structure_hls_cdn_settings(
    ...
    if let Some(var_797) = &input.hls_akamai_settings {
        let mut object_798 = object.key("hlsAkamaiSettings").start_object();
        crate::json_ser::serialize_structure_hls_akamai_settings(&mut object_798, var_797);
        object_798.finish();
    }
    if let Some(var_799) = &input.hls_basic_put_settings {
        let mut object_800 = object.key("hlsBasicPutSettings").start_object();
        crate::json_ser::serialize_structure_hls_basic_put_settings(&mut object_800, var_799);
        object_800.finish();
    }
    if let Some(var_801) = &input.hls_media_store_settings {
        let mut object_802 = object.key("hlsMediaStoreSettings").start_object();
        crate::json_ser::serialize_structure_hls_media_store_settings(&mut object_802, var_801);
        object_802.finish();
    }
    if let Some(var_803) = &input.hls_s3_settings {
        let mut object_804 = object.key("hlsS3Settings").start_object();
        crate::json_ser::serialize_structure_hls_s3_settings(&mut object_804, var_803);
        object_804.finish();
    }
    if let Some(var_805) = &input.hls_webdav_settings {
        let mut object_806 = object.key("hlsWebdavSettings").start_object();
        crate::json_ser::serialize_structure_hls_webdav_settings(&mut object_806, var_805);
        object_806.finish();
    }
}
...
pub fn serialize_structure_key_provider_settings(
    ...
    if let Some(var_807) = &input.static_key_settings {
        let mut object_808 = object.key("staticKeySettings").start_object();
        crate::json_ser::serialize_structure_static_key_settings(&mut object_808, var_807);
        object_808.finish();
    }
}
...
pub fn serialize_structure_archive_output_settings(
    ...
    if let Some(var_809) = &input.container_settings {
        let mut object_810 = object.key("containerSettings").start_object();
        crate::json_ser::serialize_structure_archive_container_settings(&mut object_810, var_809);
        object_810.finish();
    }
    if let Some(var_811) = &input.extension {
        object.key("extension").string(var_811);
    }
    if let Some(var_812) = &input.name_modifier {
        object.key("nameModifier").string(var_812);
    }
}
...
pub fn serialize_structure_frame_capture_output_settings(
    ...
    if let Some(var_813) = &input.name_modifier {
        object.key("nameModifier").string(var_813);
    }
}
...
pub fn serialize_structure_hls_output_settings(
    ...
    if let Some(var_814) = &input.h265_packaging_type {
        object.key("h265PackagingType").string(var_814.as_str());
    }
    if let Some(var_815) = &input.hls_settings {
        let mut object_816 = object.key("hlsSettings").start_object();
        crate::json_ser::serialize_structure_hls_settings(&mut object_816, var_815);
        object_816.finish();
    }
    if let Some(var_817) = &input.name_modifier {
        object.key("nameModifier").string(var_817);
    }
    if let Some(var_818) = &input.segment_modifier {
        object.key("segmentModifier").string(var_818);
    }
}
...
pub fn serialize_structure_ms_smooth_output_settings(
    ...
    if let Some(var_819) = &input.h265_packaging_type {
        object.key("h265PackagingType").string(var_819.as_str());
    }
    if let Some(var_820) = &input.name_modifier {
        object.key("nameModifier").string(var_820);
    }
}
...
pub fn serialize_structure_multiplex_output_settings(
    ...
    if let Some(var_821) = &input.destination {
        let mut object_822 = object.key("destination").start_object();
        crate::json_ser::serialize_structure_output_location_ref(&mut object_822, var_821);
        object_822.finish();
    }
}
...
pub fn serialize_structure_rtmp_output_settings(
    ...
    if let Some(var_823) = &input.certificate_mode {
        object.key("certificateMode").string(var_823.as_str());
    }
    object.key("connectionRetryInterval").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.connection_retry_interval).into()),
    );
    if let Some(var_824) = &input.destination {
        let mut object_825 = object.key("destination").start_object();
        crate::json_ser::serialize_structure_output_location_ref(&mut object_825, var_824);
        object_825.finish();
    }
    object.key("numRetries").number(
        #[allow(clippy::useless_conversion)]
...
pub fn serialize_structure_udp_output_settings(
    ...
    if let Some(var_826) = &input.container_settings {
        let mut object_827 = object.key("containerSettings").start_object();
        crate::json_ser::serialize_structure_udp_container_settings(&mut object_827, var_826);
        object_827.finish();
    }
    ...
    if let Some(var_830) = &input.fec_output_settings {
        let mut object_831 = object.key("fecOutputSettings").start_object();
        crate::json_ser::serialize_structure_fec_output_settings(&mut object_831, var_830);
        object_831.finish();
    }
}
...
pub fn serialize_structure_h264_color_space_settings(
    ...
    if let Some(var_832) = &input.color_space_passthrough_settings {
        let mut object_833 = object.key("colorSpacePassthroughSettings").start_object();
    ...
    if let Some(var_834) = &input.rec601_settings {
        let mut object_835 = object.key("rec601Settings").start_object();
        crate::json_ser::serialize_structure_rec601_settings(&mut object_835, var_834);
        object_835.finish();
    }
    if let Some(var_836) = &input.rec709_settings {
        let mut object_837 = object.key("rec709Settings").start_object();
        crate::json_ser::serialize_structure_rec709_settings(&mut object_837, var_836);
        object_837.finish();
    }
}
...
pub fn serialize_structure_h264_filter_settings(
    ...
    if let Some(var_838) = &input.temporal_filter_settings {
        let mut object_839 = object.key("temporalFilterSettings").start_object();
        crate::json_ser::serialize_structure_temporal_filter_settings(&mut object_839, var_838);
        object_839.finish();
    }
}
...
pub fn serialize_structure_h265_color_space_settings(
    ...
    if let Some(var_840) = &input.color_space_passthrough_settings {
        let mut object_841 = object.key("colorSpacePassthroughSettings").start_object();
        crate::json_ser::serialize_structure_color_space_passthrough_settings(
            &mut object_841,
            var_840,
        );
    ...
    if let Some(var_842) = &input.hdr10_settings {
        let mut object_843 = object.key("hdr10Settings").start_object();
        crate::json_ser::serialize_structure_hdr10_settings(&mut object_843, var_842);
        object_843.finish();
    }
    if let Some(var_844) = &input.rec601_settings {
        let mut object_845 = object.key("rec601Settings").start_object();
        crate::json_ser::serialize_structure_rec601_settings(&mut object_845, var_844);
        object_845.finish();
    }
    if let Some(var_846) = &input.rec709_settings {
        let mut object_847 = object.key("rec709Settings").start_object();
        crate::json_ser::serialize_structure_rec709_settings(&mut object_847, var_846);
        object_847.finish();
    }
}
...
pub fn serialize_structure_h265_filter_settings(
    ...
    if let Some(var_848) = &input.temporal_filter_settings {
        let mut object_849 = object.key("temporalFilterSettings").start_object();
        crate::json_ser::serialize_structure_temporal_filter_settings(&mut object_849, var_848);
        object_849.finish();
    }
}
...
pub fn serialize_structure_mpeg2_filter_settings(
    ...
    if let Some(var_850) = &input.temporal_filter_settings {
        let mut object_851 = object.key("temporalFilterSettings").start_object();
        crate::json_ser::serialize_structure_temporal_filter_settings(&mut object_851, var_850);
        object_851.finish();
    }
}
...
pub fn serialize_structure_audio_silence_failover_settings(
    ...
    if let Some(var_852) = &input.audio_selector_name {
        object.key("audioSelectorName").string(var_852);
    }
...
pub fn serialize_structure_audio_language_selection(
    ...
    if let Some(var_853) = &input.language_code {
        object.key("languageCode").string(var_853);
    }
    if let Some(var_854) = &input.language_selection_policy {
        object
...
pub fn serialize_structure_audio_track_selection(
    ...
    if let Some(var_855) = &input.tracks {
        let mut array_856 = object.key("tracks").start_array();
        for item_857 in var_855 {
            let mut object_858 = array_856.value().start_object();
            crate::json_ser::serialize_structure_audio_track(&mut object_858, item_857);
            object_858.finish();
        }
        array_856.finish();
    }
...
pub fn serialize_structure_embedded_source_settings(
    ...
    if let Some(var_859) = &input.convert608_to708 {
        object.key("convert608To708").string(var_859.as_str());
    }
    if let Some(var_860) = &input.scte20_detection {
        object.key("scte20Detection").string(var_860.as_str());
    }
...
pub fn serialize_structure_scte20_source_settings(
    ...
    if let Some(var_861) = &input.convert608_to708 {
        object.key("convert608To708").string(var_861.as_str());
    }
    object.key("source608ChannelNumber").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.source608_channel_number).into()),
...
pub fn serialize_structure_teletext_source_settings(
    ...
    if let Some(var_862) = &input.output_rectangle {
        let mut object_863 = object.key("outputRectangle").start_object();
        crate::json_ser::serialize_structure_caption_rectangle(&mut object_863, var_862);
        object_863.finish();
    }
    if let Some(var_864) = &input.page_number {
        object.key("pageNumber").string(var_864);
    }
}
...
pub fn serialize_structure_start_timecode(
    ...
    if let Some(var_865) = &input.timecode {
        object.key("timecode").string(var_865);
    }
}
...
pub fn serialize_structure_stop_timecode(
    ...
    if let Some(var_866) = &input.last_frame_clipping_behavior {
        object
            .key("lastFrameClippingBehavior")
            .string(var_866.as_str());
    }
    if let Some(var_867) = &input.timecode {
...
pub fn serialize_structure_scte35_descriptor_settings(
    ...
    if let Some(var_868) = &input.segmentation_descriptor_scte35_descriptor_settings {
        let mut object_869 = object
...
pub fn serialize_structure_archive_s3_settings(
    ...
    if let Some(var_870) = &input.canned_acl {
        object.key("cannedAcl").string(var_870.as_str());
    }
}
...
pub fn serialize_structure_hls_akamai_settings(
    ...
    if let Some(var_872) = &input.http_transfer_mode {
        object.key("httpTransferMode").string(var_872.as_str());
    }
    object.key("numRetries").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.num_retries).into()),
    ...
    if let Some(var_873) = &input.salt {
        object.key("salt").string(var_873);
    }
    if let Some(var_874) = &input.token {
        object.key("token").string(var_874);
    }
}
...
pub fn serialize_structure_hls_media_store_settings(
    ...
    if let Some(var_875) = &input.media_store_storage_class {
        object
...
pub fn serialize_structure_hls_s3_settings(
    ...
    if let Some(var_876) = &input.canned_acl {
        object.key("cannedAcl").string(var_876.as_str());
    }
}
...
pub fn serialize_structure_hls_webdav_settings(
    ...
    if let Some(var_877) = &input.http_transfer_mode {
        object.key("httpTransferMode").string(var_877.as_str());
    }
    object.key("numRetries").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.num_retries).into()),
...
pub fn serialize_structure_static_key_settings(
    ...
    if let Some(var_878) = &input.key_provider_server {
        let mut object_879 = object.key("keyProviderServer").start_object();
        crate::json_ser::serialize_structure_input_location(&mut object_879, var_878);
        object_879.finish();
    }
    if let Some(var_880) = &input.static_key_value {
        object.key("staticKeyValue").string(var_880);
    }
}
...
pub fn serialize_structure_archive_container_settings(
    ...
    if let Some(var_881) = &input.m2ts_settings {
        let mut object_882 = object.key("m2tsSettings").start_object();
        crate::json_ser::serialize_structure_m2ts_settings(&mut object_882, var_881);
        object_882.finish();
    }
    if let Some(var_883) = &input.raw_settings {
        let mut object_884 = object.key("rawSettings").start_object();
        crate::json_ser::serialize_structure_raw_settings(&mut object_884, var_883);
        object_884.finish();
    }
}
...
pub fn serialize_structure_hls_settings(
    ...
    if let Some(var_885) = &input.audio_only_hls_settings {
        let mut object_886 = object.key("audioOnlyHlsSettings").start_object();
        crate::json_ser::serialize_structure_audio_only_hls_settings(&mut object_886, var_885);
        object_886.finish();
    }
    if let Some(var_887) = &input.fmp4_hls_settings {
        let mut object_888 = object.key("fmp4HlsSettings").start_object();
        crate::json_ser::serialize_structure_fmp4_hls_settings(&mut object_888, var_887);
        object_888.finish();
    }
    if let Some(var_889) = &input.frame_capture_hls_settings {
        let mut object_890 = object.key("frameCaptureHlsSettings").start_object();
        crate::json_ser::serialize_structure_frame_capture_hls_settings(&mut object_890, var_889);
        object_890.finish();
    }
    if let Some(var_891) = &input.standard_hls_settings {
        let mut object_892 = object.key("standardHlsSettings").start_object();
        crate::json_ser::serialize_structure_standard_hls_settings(&mut object_892, var_891);
        object_892.finish();
    }
}
...
pub fn serialize_structure_udp_container_settings(
    ...
    if let Some(var_893) = &input.m2ts_settings {
        let mut object_894 = object.key("m2tsSettings").start_object();
        crate::json_ser::serialize_structure_m2ts_settings(&mut object_894, var_893);
        object_894.finish();
    }
}
...
pub fn serialize_structure_fec_output_settings(
    ...
    if let Some(var_895) = &input.include_fec {
        object.key("includeFec").string(var_895.as_str());
    }
...
pub fn serialize_structure_temporal_filter_settings(
    ...
    if let Some(var_896) = &input.post_filter_sharpening {
        object.key("postFilterSharpening").string(var_896.as_str());
    }
    if let Some(var_897) = &input.strength {
        object.key("strength").string(var_897.as_str());
    }
}
...
pub fn serialize_structure_scte35_segmentation_descriptor(
    ...
    if let Some(var_898) = &input.delivery_restrictions {
        let mut object_899 = object.key("deliveryRestrictions").start_object();
        crate::json_ser::serialize_structure_scte35_delivery_restrictions(&mut object_899, var_898);
        object_899.finish();
    }
    ...
    if let Some(var_900) = &input.segmentation_cancel_indicator {
        object
    ...
    if let Some(var_901) = &input.segmentation_upid {
        object.key("segmentationUpid").string(var_901);
    }
...
pub fn serialize_structure_m2ts_settings(
    ...
    if let Some(var_902) = &input.absent_input_audio_behavior {
        object
            .key("absentInputAudioBehavior")
            .string(var_902.as_str());
    }
    if let Some(var_903) = &input.arib {
        object.key("arib").string(var_903.as_str());
    }
    if let Some(var_904) = &input.arib_captions_pid {
        object.key("aribCaptionsPid").string(var_904);
    }
    if let Some(var_905) = &input.arib_captions_pid_control {
        object
            .key("aribCaptionsPidControl")
            .string(var_905.as_str());
    }
    if let Some(var_906) = &input.audio_buffer_model {
        object.key("audioBufferModel").string(var_906.as_str());
    }
    object.key("audioFramesPerPes").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.audio_frames_per_pes).into()),
    );
    if let Some(var_907) = &input.audio_pids {
        object.key("audioPids").string(var_907);
    }
    if let Some(var_908) = &input.audio_stream_type {
        object.key("audioStreamType").string(var_908.as_str());
    }
    object.key("bitrate").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.bitrate).into()),
    );
    if let Some(var_909) = &input.buffer_model {
        object.key("bufferModel").string(var_909.as_str());
    }
    if let Some(var_910) = &input.cc_descriptor {
        object.key("ccDescriptor").string(var_910.as_str());
    }
    if let Some(var_911) = &input.dvb_nit_settings {
        let mut object_912 = object.key("dvbNitSettings").start_object();
        crate::json_ser::serialize_structure_dvb_nit_settings(&mut object_912, var_911);
        object_912.finish();
    }
    if let Some(var_913) = &input.dvb_sdt_settings {
        let mut object_914 = object.key("dvbSdtSettings").start_object();
        crate::json_ser::serialize_structure_dvb_sdt_settings(&mut object_914, var_913);
        object_914.finish();
    }
    if let Some(var_915) = &input.dvb_sub_pids {
        object.key("dvbSubPids").string(var_915);
    }
    if let Some(var_916) = &input.dvb_tdt_settings {
        let mut object_917 = object.key("dvbTdtSettings").start_object();
        crate::json_ser::serialize_structure_dvb_tdt_settings(&mut object_917, var_916);
        object_917.finish();
    }
    if let Some(var_918) = &input.dvb_teletext_pid {
        object.key("dvbTeletextPid").string(var_918);
    }
    if let Some(var_919) = &input.ebif {
        object.key("ebif").string(var_919.as_str());
    }
    if let Some(var_920) = &input.ebp_audio_interval {
        object.key("ebpAudioInterval").string(var_920.as_str());
    }
    object.key("ebpLookaheadMs").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.ebp_lookahead_ms).into()),
    );
    if let Some(var_921) = &input.ebp_placement {
        object.key("ebpPlacement").string(var_921.as_str());
    }
    if let Some(var_922) = &input.ecm_pid {
        object.key("ecmPid").string(var_922);
    }
    if let Some(var_923) = &input.es_rate_in_pes {
        object.key("esRateInPes").string(var_923.as_str());
    }
    if let Some(var_924) = &input.etv_platform_pid {
        object.key("etvPlatformPid").string(var_924);
    }
    if let Some(var_925) = &input.etv_signal_pid {
        object.key("etvSignalPid").string(var_925);
    }
    object.key("fragmentTime").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::Float((input.fragment_time).into()),
    );
    if let Some(var_926) = &input.klv {
        object.key("klv").string(var_926.as_str());
    }
    if let Some(var_927) = &input.klv_data_pids {
        object.key("klvDataPids").string(var_927);
    }
    if let Some(var_928) = &input.nielsen_id3_behavior {
        object.key("nielsenId3Behavior").string(var_928.as_str());
    }
    ...
    if let Some(var_929) = &input.pcr_control {
        object.key("pcrControl").string(var_929.as_str());
    }
    object.key("pcrPeriod").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.pcr_period).into()),
    );
    if let Some(var_930) = &input.pcr_pid {
        object.key("pcrPid").string(var_930);
    }
    object.key("pmtInterval").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.pmt_interval).into()),
    );
    if let Some(var_931) = &input.pmt_pid {
        object.key("pmtPid").string(var_931);
    }
    object.key("programNum").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.program_num).into()),
    );
    if let Some(var_932) = &input.rate_mode {
        object.key("rateMode").string(var_932.as_str());
    }
    if let Some(var_933) = &input.scte27_pids {
        object.key("scte27Pids").string(var_933);
    }
    if let Some(var_934) = &input.scte35_control {
        object.key("scte35Control").string(var_934.as_str());
    }
    if let Some(var_935) = &input.scte35_pid {
        object.key("scte35Pid").string(var_935);
    }
    if let Some(var_936) = &input.segmentation_markers {
        object.key("segmentationMarkers").string(var_936.as_str());
    }
    if let Some(var_937) = &input.segmentation_style {
        object.key("segmentationStyle").string(var_937.as_str());
    }
    object.key("segmentationTime").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::Float((input.segmentation_time).into()),
    );
    if let Some(var_938) = &input.timed_metadata_behavior {
        object.key("timedMetadataBehavior").string(var_938.as_str());
    }
    if let Some(var_939) = &input.timed_metadata_pid {
        object.key("timedMetadataPid").string(var_939);
    }
    object.key("transportStreamId").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.transport_stream_id).into()),
    );
    if let Some(var_940) = &input.video_pid {
        object.key("videoPid").string(var_940);
    }
}
...
pub fn serialize_structure_audio_only_hls_settings(
    ...
    if let Some(var_941) = &input.audio_group_id {
        object.key("audioGroupId").string(var_941);
    }
    if let Some(var_942) = &input.audio_only_image {
        let mut object_943 = object.key("audioOnlyImage").start_object();
        crate::json_ser::serialize_structure_input_location(&mut object_943, var_942);
        object_943.finish();
    }
    if let Some(var_944) = &input.audio_track_type {
        object.key("audioTrackType").string(var_944.as_str());
    }
    if let Some(var_945) = &input.segment_type {
        object.key("segmentType").string(var_945.as_str());
    }
}
...
pub fn serialize_structure_fmp4_hls_settings(
    ...
    if let Some(var_946) = &input.audio_rendition_sets {
        object.key("audioRenditionSets").string(var_946);
    }
    if let Some(var_947) = &input.nielsen_id3_behavior {
        object.key("nielsenId3Behavior").string(var_947.as_str());
    }
    if let Some(var_948) = &input.timed_metadata_behavior {
        object.key("timedMetadataBehavior").string(var_948.as_str());
    }
}
...
pub fn serialize_structure_standard_hls_settings(
    ...
    if let Some(var_949) = &input.audio_rendition_sets {
        object.key("audioRenditionSets").string(var_949);
    }
    if let Some(var_950) = &input.m3u8_settings {
        let mut object_951 = object.key("m3u8Settings").start_object();
        crate::json_ser::serialize_structure_m3u8_settings(&mut object_951, var_950);
        object_951.finish();
    }
}
...
pub fn serialize_structure_scte35_delivery_restrictions(
    ...
    if let Some(var_952) = &input.archive_allowed_flag {
        object.key("archiveAllowedFlag").string(var_952.as_str());
    }
    if let Some(var_953) = &input.device_restrictions {
        object.key("deviceRestrictions").string(var_953.as_str());
    }
    if let Some(var_954) = &input.no_regional_blackout_flag {
        object
            .key("noRegionalBlackoutFlag")
            .string(var_954.as_str());
    }
    if let Some(var_955) = &input.web_delivery_allowed_flag {
        object
            .key("webDeliveryAllowedFlag")
...
pub fn serialize_structure_dvb_nit_settings(
    ...
    if let Some(var_956) = &input.network_name {
        object.key("networkName").string(var_956);
    }
...
pub fn serialize_structure_dvb_sdt_settings(
    ...
    if let Some(var_957) = &input.output_sdt {
        object.key("outputSdt").string(var_957.as_str());
    }
    object.key("repInterval").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.rep_interval).into()),
    ...
    if let Some(var_959) = &input.service_provider_name {
        object.key("serviceProviderName").string(var_959);
    }
}
...
pub fn serialize_structure_m3u8_settings(
    ...
    if let Some(var_960) = &input.audio_pids {
        object.key("audioPids").string(var_960);
    }
    if let Some(var_961) = &input.ecm_pid {
        object.key("ecmPid").string(var_961);
    }
    if let Some(var_962) = &input.nielsen_id3_behavior {
        object.key("nielsenId3Behavior").string(var_962.as_str());
    }
    object.key("patInterval").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.pat_interval).into()),
    );
    if let Some(var_963) = &input.pcr_control {
        object.key("pcrControl").string(var_963.as_str());
    }
    object.key("pcrPeriod").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.pcr_period).into()),
    );
    if let Some(var_964) = &input.pcr_pid {
        object.key("pcrPid").string(var_964);
    }
    object.key("pmtInterval").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.pmt_interval).into()),
    );
    if let Some(var_965) = &input.pmt_pid {
        object.key("pmtPid").string(var_965);
    }
    object.key("programNum").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.program_num).into()),
    );
    if let Some(var_966) = &input.scte35_behavior {
        object.key("scte35Behavior").string(var_966.as_str());
    }
    if let Some(var_967) = &input.scte35_pid {
        object.key("scte35Pid").string(var_967);
    }
    if let Some(var_968) = &input.timed_metadata_behavior {
        object.key("timedMetadataBehavior").string(var_968.as_str());
    }
    if let Some(var_969) = &input.timed_metadata_pid {
        object.key("timedMetadataPid").string(var_969);
    }
    object.key("transportStreamId").number(
        #[allow(clippy::useless_conversion)]
        smithy_types::Number::NegInt((input.transport_stream_id).into()),
    );
    if let Some(var_970) = &input.video_pid {
        object.key("videoPid").string(var_970);
    }
}
