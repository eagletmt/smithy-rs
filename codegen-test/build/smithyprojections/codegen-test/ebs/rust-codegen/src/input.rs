...
pub mod complete_snapshot_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> CompleteSnapshot {
...
pub mod get_snapshot_block_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> GetSnapshotBlock {
...
pub mod list_changed_blocks_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ListChangedBlocks {
...
pub mod list_snapshot_blocks_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> ListSnapshotBlocks {
...
pub mod put_snapshot_block_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> PutSnapshotBlock {
...
pub mod start_snapshot_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> StartSnapshot {
