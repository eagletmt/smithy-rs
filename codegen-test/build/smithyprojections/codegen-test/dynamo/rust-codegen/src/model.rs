...
pub mod time_to_live_specification {
    ...
    impl Builder {
        ...
        /// <p>The name of the TTL attribute used to store the expiration time for items in the
        /// table.</p>
        pub fn attribute_name(mut self, inp: impl Into<String>) -> Self {
...
pub mod table_auto_scaling_description {
    ...
    impl Builder {
        ...
        /// <p>Represents replicas of the global table.</p>
        pub fn replicas(mut self, inp: Vec<ReplicaAutoScalingDescription>) -> Self {
...
pub mod replica_auto_scaling_description {
    ...
    impl Builder {
        ...
        pub fn global_secondary_indexes(
            mut self,
            inp: Vec<ReplicaGlobalSecondaryIndexAutoScalingDescription>,
        ) -> Self {
...
pub mod auto_scaling_settings_description {
    ...
    impl Builder {
        ...
        /// <p>Role ARN used for configuring the auto scaling policy.</p>
        pub fn auto_scaling_role_arn(mut self, inp: impl Into<String>) -> Self {
            self.auto_scaling_role_arn = Some(inp.into());
            self
        }
        /// <p>Information about the scaling policies.</p>
        pub fn scaling_policies(mut self, inp: Vec<AutoScalingPolicyDescription>) -> Self {
...
pub mod auto_scaling_policy_description {
    ...
    impl Builder {
        /// <p>The name of the scaling policy.</p>
        pub fn policy_name(mut self, inp: impl Into<String>) -> Self {
...
pub mod replica_auto_scaling_update {
    ...
    impl Builder {
        ...
        pub fn replica_global_secondary_index_updates(
            mut self,
            inp: Vec<ReplicaGlobalSecondaryIndexAutoScalingUpdate>,
        ) -> Self {
...
pub mod table_description {
    ...
    pub struct Builder {
        ...
        table_status: Option<TableStatus>,
        creation_date_time: Option<Instant>,
    ...
    impl Builder {
        ...
        /// <p>Unique identifier for the table for which the backup was created. </p>
        pub fn table_id(mut self, inp: impl Into<String>) -> Self {
        ...
        /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be
        /// returned.</p>
        pub fn local_secondary_indexes(mut self, inp: Vec<LocalSecondaryIndexDescription>) -> Self {
        ...
        pub fn global_secondary_indexes(
            mut self,
            inp: Vec<GlobalSecondaryIndexDescription>,
        ) -> Self {
            self.global_secondary_indexes = Some(inp);
            self
        }
        ...
        /// </li>
        /// </ul>
        pub fn latest_stream_label(mut self, inp: impl Into<String>) -> Self {
            self.latest_stream_label = Some(inp.into());
            self
        }
        /// <p>The Amazon Resource Name (ARN) that uniquely identifies the latest stream for this table.</p>
        pub fn latest_stream_arn(mut self, inp: impl Into<String>) -> Self {
            self.latest_stream_arn = Some(inp.into());
            self
        }
        /// <p>Represents the version of <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GlobalTables.html">global tables</a> in use, if the table is replicated across AWS Regions.</p>
        pub fn global_table_version(mut self, inp: impl Into<String>) -> Self {
            self.global_table_version = Some(inp.into());
            self
        }
        /// <p>Represents replicas of the table.</p>
        pub fn replicas(mut self, inp: Vec<ReplicaDescription>) -> Self {
            self.replicas = Some(inp);
            self
        }
        /// <p>Contains details for the restore.</p>
...
pub struct ArchivalSummary {
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub archival_date_time: Option<Instant>,
...
pub mod archival_summary {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        archival_date_time: Option<Instant>,
    ...
    impl Builder {
        ...
        /// </li>
        /// </ul>
        pub fn archival_reason(mut self, inp: impl Into<String>) -> Self {
        ...
        /// backup to the same table name, you will need to delete the original
        /// table.</p>
        pub fn archival_backup_arn(mut self, inp: impl Into<String>) -> Self {
...
pub mod sse_description {
    ...
    impl Builder {
        ...
        /// <p>The AWS KMS customer master key (CMK) ARN used for the AWS KMS encryption.</p>
        pub fn kms_master_key_arn(mut self, inp: impl Into<String>) -> Self {
...
pub mod restore_summary {
    ...
    impl Builder {
        /// <p>The Amazon Resource Name (ARN) of the backup from which the table was restored.</p>
        pub fn source_backup_arn(mut self, inp: impl Into<String>) -> Self {
...
pub struct ReplicaDescription {
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub replica_inaccessible_date_time: Option<Instant>,
}
...
pub mod replica_description {
    ...
    pub struct Builder {
        ...
        replica_inaccessible_date_time: Option<Instant>,
    }
    impl Builder {
        /// <p>The name of the Region.</p>
        pub fn region_name(mut self, inp: impl Into<String>) -> Self {
        ...
        /// <p>Detailed information about the replica status.</p>
        pub fn replica_status_description(mut self, inp: impl Into<String>) -> Self {
            self.replica_status_description = Some(inp.into());
            self
        }
        /// <p>Specifies the progress of a Create, Update, or Delete action on the replica
        /// as a percentage.</p>
        pub fn replica_status_percent_progress(mut self, inp: impl Into<String>) -> Self {
            self.replica_status_percent_progress = Some(inp.into());
            self
        }
        /// <p>The AWS KMS customer master key (CMK) of the replica that will be used for AWS KMS
        /// encryption.</p>
        pub fn kms_master_key_id(mut self, inp: impl Into<String>) -> Self {
        ...
        pub fn global_secondary_indexes(
            mut self,
            inp: Vec<ReplicaGlobalSecondaryIndexDescription>,
        ) -> Self {
            self.global_secondary_indexes = Some(inp);
            self
        }
...
pub mod global_secondary_index_description {
    ...
    impl Builder {
        ...
        /// <p>The Amazon Resource Name (ARN) that uniquely identifies the index.</p>
        pub fn index_arn(mut self, inp: impl Into<String>) -> Self {
...
pub mod provisioned_throughput_description {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        last_increase_date_time: Option<Instant>,
...
pub mod projection {
    ...
    impl Builder {
        ...
        /// must not exceed 20. If you project the same attribute into two
        /// different indexes, this counts as two distinct attributes when determining the total.</p>
        pub fn non_key_attributes(mut self, inp: Vec<String>) -> Self {
...
pub struct BillingModeSummary {
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub last_update_to_pay_per_request_date_time: Option<Instant>,
}
...
pub mod billing_mode_summary {
    ...
    pub struct Builder {
        ...
        last_update_to_pay_per_request_date_time: Option<Instant>,
    }
    impl Builder {
        /// <p>Controls how you are charged for read and write throughput and how you manage capacity. This setting can be changed later.</p>
        /// <ul>
...
pub struct AttributeDefinition {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attribute_type: Option<ScalarAttributeType>,
}
...
pub mod update_replication_group_member_action {
    ...
    impl Builder {
        ...
        /// <p>Replica-specific global secondary index settings.</p>
        pub fn global_secondary_indexes(mut self, inp: Vec<ReplicaGlobalSecondaryIndex>) -> Self {
            self.global_secondary_indexes = Some(inp);
            self
        }
...
pub mod item_collection_metrics {
    ...
    impl Builder {
        /// <p>The partition key value of the item collection. This value is the same as the partition key value of the item.</p>
        pub fn item_collection_key(mut self, inp: HashMap<String, AttributeValue>) -> Self {
            self.item_collection_key = Some(inp);
            self
        }
        /// <p>An estimate of item collection size, in gigabytes. This value is a two-element array containing a lower bound and an upper bound for the estimate. The estimate includes the size of all the items in the table, plus the size of all attributes projected into all of the local secondary indexes on that table. Use this estimate to measure whether a local secondary index is approaching its size limit.</p>
        /// <p>The estimate is subject to change over time; therefore, do not rely on the precision or accuracy of the estimate.</p>
        pub fn size_estimate_range_gb(mut self, inp: Vec<f64>) -> Self {
...
pub enum AttributeValue {
    ...
    Bool(bool),
    #[serde(rename = "BS")]
    #[serde(serialize_with = "crate::serde_util::vecblob_ser")]
    #[serde(deserialize_with = "crate::serde_util::vecblob_deser")]
    Bs(Vec<Blob>),
    #[serde(rename = "L")]
...
pub mod consumed_capacity {
    ...
    impl Builder {
        ...
        /// <p>The amount of throughput consumed on each local index affected by the operation.</p>
        pub fn local_secondary_indexes(mut self, inp: HashMap<String, Capacity>) -> Self {
            self.local_secondary_indexes = Some(inp);
            self
        }
        /// <p>The amount of throughput consumed on each global index affected by the operation.</p>
        pub fn global_secondary_indexes(mut self, inp: HashMap<String, Capacity>) -> Self {
            self.global_secondary_indexes = Some(inp);
            self
        }
...
pub mod expected_attribute_value {
    ...
    impl Builder {
        ...
        /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
        /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
        pub fn attribute_value_list(mut self, inp: Vec<AttributeValue>) -> Self {
...
pub mod replica_settings_description {
    ...
    impl Builder {
        ...
        pub fn replica_global_secondary_index_settings(
            mut self,
            inp: Vec<ReplicaGlobalSecondaryIndexSettingsDescription>,
        ) -> Self {
...
pub mod replica_settings_update {
    ...
    impl Builder {
        ...
        pub fn replica_global_secondary_index_settings_update(
            mut self,
            inp: Vec<ReplicaGlobalSecondaryIndexSettingsUpdate>,
        ) -> Self {
...
pub mod global_table_description {
    ...
    impl Builder {
        /// <p>The Regions where the global table has replicas.</p>
        pub fn replication_group(mut self, inp: Vec<ReplicaDescription>) -> Self {
            self.replication_group = Some(inp);
            self
        }
        /// <p>The unique identifier of the global table.</p>
        pub fn global_table_arn(mut self, inp: impl Into<String>) -> Self {
...
pub struct ContinuousBackupsDescription {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub continuous_backups_status: Option<ContinuousBackupsStatus>,
...
pub mod continuous_backups_description {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        continuous_backups_status: Option<ContinuousBackupsStatus>,
...
pub struct PointInTimeRecoveryDescription {
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub earliest_restorable_date_time: Option<Instant>,
    /// <p>
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub latest_restorable_date_time: Option<Instant>,
}
...
pub mod point_in_time_recovery_description {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        point_in_time_recovery_status: Option<PointInTimeRecoveryStatus>,
        earliest_restorable_date_time: Option<Instant>,
        latest_restorable_date_time: Option<Instant>,
    }
    impl Builder {
        /// <p>The current state of point in time recovery:</p>
        /// <ul>
...
pub struct BackupSummary {
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub backup_creation_date_time: Option<Instant>,
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub backup_expiry_date_time: Option<Instant>,
...
pub mod backup_summary {
    ...
    pub struct Builder {
        ...
        backup_creation_date_time: Option<Instant>,
        backup_expiry_date_time: Option<Instant>,
...
pub mod export_description {
    ...
    impl Builder {
        ...
        /// <p>The name of the manifest file for the export task.</p>
        pub fn export_manifest(mut self, inp: impl Into<String>) -> Self {
        ...
        /// <p>Status code for the result of the failed export.</p>
        pub fn failure_code(mut self, inp: impl Into<String>) -> Self {
            self.failure_code = Some(inp.into());
            self
        }
        /// <p>Export failure reason description.</p>
        pub fn failure_message(mut self, inp: impl Into<String>) -> Self {
...
pub mod time_to_live_description {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        time_to_live_status: Option<TimeToLiveStatus>,
        attribute_name: Option<String>,
    }
    impl Builder {
        /// <p> The TTL status for the table.</p>
...
pub mod kinesis_data_stream_destination {
    ...
    impl Builder {
        ...
        /// <p>The human-readable string that corresponds to the replica status.</p>
        pub fn destination_status_description(mut self, inp: impl Into<String>) -> Self {
...
pub mod endpoint {
    ...
    pub struct Builder {
        ...
        cache_period_in_minutes: Option<i64>,
    }
    impl Builder {
        /// <p>IP address of the endpoint.</p>
        pub fn address(mut self, inp: impl Into<String>) -> Self {
...
pub mod failure_exception {
    ...
    impl Builder {
        /// <p>Exception name.</p>
        pub fn exception_name(mut self, inp: impl Into<String>) -> Self {
            self.exception_name = Some(inp.into());
            self
        }
        /// <p>Description of the failure.</p>
        pub fn exception_description(mut self, inp: impl Into<String>) -> Self {
...
pub mod source_table_feature_details {
    ...
    impl Builder {
        /// <p>Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. </p>
        pub fn local_secondary_indexes(mut self, inp: Vec<LocalSecondaryIndexInfo>) -> Self {
            self.local_secondary_indexes = Some(inp);
            self
        }
        /// <p>Represents the GSI properties for the table when the backup was created. It includes the
        /// IndexName, KeySchema, Projection, and ProvisionedThroughput for the GSIs on the table at
        /// the time of backup. </p>
        pub fn global_secondary_indexes(mut self, inp: Vec<GlobalSecondaryIndexInfo>) -> Self {
            self.global_secondary_indexes = Some(inp);
            self
        }
        /// <p>Stream settings on the table when the backup was created.</p>
...
pub struct SourceTableDetails {
    ...
    #[serde(serialize_with = "crate::serde_util::optioninstant_epoch_seconds_ser")]
    #[serde(deserialize_with = "crate::serde_util::optioninstant_epoch_seconds_deser")]
    pub table_creation_date_time: Option<Instant>,
...
pub mod source_table_details {
    ...
    pub struct Builder {
        ...
        table_size_bytes: Option<i64>,
        key_schema: Option<Vec<KeySchemaElement>>,
        table_creation_date_time: Option<Instant>,
        provisioned_throughput: Option<ProvisionedThroughput>,
        item_count: Option<i64>,
        billing_mode: Option<BillingMode>,
    }
...
pub mod keys_and_attributes {
    ...
    #[derive(Debug, Clone, Default)]
    pub struct Builder {
        keys: Option<Vec<HashMap<String, AttributeValue>>>,
    ...
    impl Builder {
        /// <p>The primary key attribute values that define the items and the attributes associated with the items.</p>
        pub fn keys(mut self, inp: Vec<HashMap<String, AttributeValue>>) -> Self {
            self.keys = Some(inp);
            self
        }
        /// <p>This is a legacy parameter.  Use <code>ProjectionExpression</code> instead.  For more information, see
