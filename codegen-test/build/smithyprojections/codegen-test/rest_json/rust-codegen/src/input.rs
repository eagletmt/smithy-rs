                ...
                HttpRequestWithLabelsAndTimestampFormat::new(
                    HttpRequestWithLabelsAndTimestampFormatInput {
                        ...
                        member_http_date: self.member_http_date
                            .ok_or("member_http_date is required when building HttpRequestWithLabelsAndTimestampFormatInput")?
                        ,
                        member_date_time: self.member_date_time
                            .ok_or("member_date_time is required when building HttpRequestWithLabelsAndTimestampFormatInput")?
                        ,
                        default_format: self.default_format
                            .ok_or("default_format is required when building HttpRequestWithLabelsAndTimestampFormatInput")?
                        ,
                        target_epoch_seconds: self.target_epoch_seconds
                            .ok_or("target_epoch_seconds is required when building HttpRequestWithLabelsAndTimestampFormatInput")?
                        ,
                        target_http_date: self.target_http_date
                            .ok_or("target_http_date is required when building HttpRequestWithLabelsAndTimestampFormatInput")?
                        ,
